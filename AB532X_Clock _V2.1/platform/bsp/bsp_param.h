...
#define PARAM_BRIGHT_LV				0x50		//屏幕亮度       1 Byte

#define PARAM_ALRAM1_HOUR			0x51		//闹钟1时钟位 1 Byte
#define PARAM_ALRAM1_MIN			0x52		//闹钟1分钟位 1 Byte
#define PARAM_ALRAM2_HOUR			0x53		//闹钟2时钟位 1 Byte
#define PARAM_ALRAM2_MIN			0x54		//闹钟2分钟位 1 Byte
