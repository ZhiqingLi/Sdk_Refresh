...
void param_init(bool reset)
{
	...
	param_sys_bright_read();
    if (sys_cb.bright_lv >= 3) {
        sys_cb.bright_lv = 0;
    }

	param_sys_arlam1_read();
	param_sys_arlam2_read();
}
...
AT(.text.bsp.param)
void param_sys_bright_write(void)
{
    param_write((u8 *)&sys_cb.bright_lv, PARAM_BRIGHT_LV, 1);
}

AT(.text.bsp.param)
void param_sys_bright_read(void)
{
    param_read((u8 *)&sys_cb.bright_lv, PARAM_BRIGHT_LV, 1);
}

AT(.text.bsp.param)
void param_sys_arlam1_write(void)
{
    param_write((u8 *)&rtcalm_tm1.tm_hour, PARAM_ALRAM1_HOUR, 1);
    param_write((u8 *)&rtcalm_tm1.tm_min,  PARAM_ALRAM1_MIN, 1);
}


AT(.text.bsp.param)
void param_sys_arlam1_read(void)
{
    param_read((u8 *)&rtcalm_tm1.tm_hour, PARAM_ALRAM1_HOUR, 1);
    param_read((u8 *)&rtcalm_tm1.tm_min, PARAM_ALRAM1_MIN, 1);
}


AT(.text.bsp.param)
void param_sys_arlam2_write(void)
{
    param_write((u8 *)&rtcalm_tm2.tm_hour, PARAM_ALRAM2_HOUR, 1);
    param_write((u8 *)&rtcalm_tm2.tm_min,  PARAM_ALRAM2_MIN, 1);
}


AT(.text.bsp.param)
void param_sys_arlam2_read(void)
{
    param_read((u8 *)&rtcalm_tm2.tm_hour, PARAM_ALRAM2_HOUR, 1);
    param_read((u8 *)&rtcalm_tm2.tm_min, PARAM_ALRAM2_MIN, 1);
}
