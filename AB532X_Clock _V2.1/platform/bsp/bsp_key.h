...
#define K_CLOCK            		(KEY_CLOCK | KEY_SHORT)
#define KU_CLOCK           		(KEY_CLOCK | KEY_SHORT_UP)
#define KL_CLOCK           		(KEY_CLOCK | KEY_LONG)
#define KLU_CLOCK          		(KEY_CLOCK | KEY_LONG_UP)
#define KH_CLOCK           		(KEY_CLOCK | KEY_HOLD)
#define KD_CLOCK           		(KEY_CLOCK | KEY_DOUBLE)
#define KLH_CLOCK          		(KEY_CLOCK | KEY_LHOLD)
