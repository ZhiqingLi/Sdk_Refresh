...
//AT(.com_text.port.str)
//const char str1[] = "vla:%x\r\n";
...
void vbat_icon_prossing(void)
{
	static u32 vbat_acc = 0;
	static u8  vbat_cnt = 0, vbat_lv1_cnt = 0, vbat_lv2_cnt = 0, vbat_lv3_cnt = 0, vbat_lv4_cnt = 0, cnt = 0;
	...
	if(vbat_cnt >= 200){
		...
		if(vbat_acc < 3420){
			...
			vbat_lv3_cnt = 0;
			vbat_lv4_cnt = 0;
			if(vbat_lv2_cnt > FILTER_CNT){
				vbat_lv2_cnt = FILTER_CNT;
				sys_cb.vbat_icon_lv = 3;
			}
		}else if(vbat_acc < 3650){
			vbat_lv1_cnt++;
			vbat_lv2_cnt = 0;
			vbat_lv3_cnt = 0;
			vbat_lv4_cnt = 0;
			if(vbat_lv1_cnt > FILTER_CNT){
				vbat_lv1_cnt = FILTER_CNT;
				sys_cb.vbat_icon_lv = 2;
			}
		}else if(vbat_acc < 3900){
			vbat_lv3_cnt++;
			vbat_lv1_cnt = 0;
			vbat_lv2_cnt = 0;
			vbat_lv4_cnt = 0;
			if(vbat_lv3_cnt > FILTER_CNT){
				vbat_lv3_cnt = FILTER_CNT;
				sys_cb.vbat_icon_lv = 1;
			}
		}else{
			vbat_lv4_cnt++;
			vbat_lv1_cnt = 0;
			vbat_lv2_cnt = 0;
			vbat_lv3_cnt = 0;
			if(vbat_lv4_cnt > FILTER_CNT){
				vbat_lv4_cnt = FILTER_CNT;
				sys_cb.vbat_icon_lv = 0;
			}
		}	
		//printf("LV: %d\r\n", sys_cb.vbat_icon_lv);
		vbat_acc = 0;
