...
#define MCU_IOTN_LBC_NNN	  	0x1A07	//- MCU通知WIFI设备功能
#define MCU_PAS_IOTN__ON 	  	0x1A08	//- 通知WIFI状态，开启设备
#define MCU_PAS_IOTN_OFF 	  	0x1A09	//- 通知WIFI状态 ，关闭设备
#define MCU_PAS_IOTN_COLOR 	  	0x1A0A	//- MCU通知WIFI相应颜色
#define MCU_PAS_IOTN_LIGHT	  	0x1A0B	//- MCU通知WIFI设备亮度
