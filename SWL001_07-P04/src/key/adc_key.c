...
//	PDS(按键开始)			SPR(短按松开)		  	CPS(长按开始)		  	 CPH(长按保持)			  CPR(长按松开)
	{MSG_NONE,			MSG_MODE,			MSG_NONE,			 MSG_NONE,			  MSG_NONE		},	//SW1
	{MSG_NONE,			MSG_WIFI_TALK,  	MSG_NONE, 		     MSG_NONE, 		      MSG_NONE		},	//SW2
	{MSG_NONE,			MSG_WIFI_MIC,       MSG_NONE, 	   	     MSG_NONE,	  		  MSG_NONE		},	//SW3
	{MSG_NONE,			MSG_PLAY_PAUSE, 	MSG_STOP, 	       	 MSG_NONE,            MSG_NONE  	},	//SW4
	{MSG_NONE,			MSG_VOL_DW,         MSG_PRE,             MSG_RTC_SET_DW,	  MSG_NONE  	},	//SW5
	
	{MSG_NONE,			MSG_VOL_UP,         MSG_NEXT, 			 MSG_RTC_SET_UP,      MSG_NONE  	},	//SW6
	{MSG_NONE,			MSG_LIGHT_PWM_SET,	MSG_LIGHT_ON_OFF,	 MSG_NONE,			  MSG_NONE		},	//SW7
	{MSG_NONE,			MSG_RTC_SET_PARM, 	MSG_WIFI_WPS,        MSG_NONE,            MSG_NONE		},	//SW8
