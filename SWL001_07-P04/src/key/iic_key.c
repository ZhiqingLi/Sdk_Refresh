...
#define 	IIC_KEY_JITTER_TIME	  		20
#define		IIC_KEY_CP_TIME				2000	//CP condition is 1s
...
// PDS(按键开始)		      SPR(短按松开)		        CPS(长按开始)		       CPH(长按保持)	        	CPR(长按松开)
	{MSG_NONE,			  MSG_NONE, 			MSG_NONE, 		       MSG_NONE,	 	        MSG_NONE 		},	//VOL-
	{MSG_NONE,			  MSG_NONE, 			MSG_NONE,			   MSG_NONE, 			    MSG_NONE		},	//EQ
	{MSG_NONE,			  MSG_NONE, 			MSG_NONE, 		   	   MSG_NONE, 			    MSG_NONE		},	//MUTE	

	{MSG_NONE,			  MSG_MODE, 			MSG_POWER, 		       MSG_NONE,	 	        MSG_NONE 		},	//VOL-
	{MSG_NONE,			  MSG_NONE, 			MSG_NONE, 		       MSG_NONE,	 	        MSG_NONE        },	//PRE	
	{MSG_NONE,			  MSG_PLAY_PAUSE, 		MSG_STOP, 	       	   MSG_NONE,            	MSG_NONE		},	//VOL+	

	{MSG_NONE,			  MSG_WIFI_MIC, 		MSG_NONE, 		       MSG_NONE, 		        MSG_NONE		},	//MODE
	{MSG_NONE,			  MSG_WIFI_TALK, 		MSG_NONE, 		       MSG_NONE, 		        MSG_NONE		},	//VOL-
	{MSG_NONE,			  MSG_LIGHT_PWM_SET,	MSG_LIGHT_ON_OFF,	   MSG_NONE,			    MSG_NONE		},	//PLAY/PAUSE

	{MSG_NONE,			  MSG_VOL_DW, 		    MSG_LIGHT_SET_DW,	   MSG_LIGHT_SET_DW, 		MSG_NONE		},	//VOL-
	{MSG_NONE,			  MSG_VOL_UP, 		    MSG_LIGHT_SET_UP,	   MSG_LIGHT_SET_UP,        MSG_NONE		},	//REPEAT
