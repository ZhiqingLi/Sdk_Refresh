...
InquriyResultParam BtGetInquiryResultParams(void);
unsigned char BTSetInquiryMode(unsigned char mode);
unsigned char BTSetInquiryCancel(void);
...
#define PROFILE_A2DP		0x01
#define PROFILE_HFP			0x02
#define PROFILE_AVRCP		0x04
#define PROFILE_SPP			0x08
