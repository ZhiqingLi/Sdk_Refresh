...
#define CFG_VOLUME_ADC_ANA_LIN1                (   53)  //59: 1.10 dB
...
#define AUDIO_EFFECT_PARAM_VB_CUTOFF_FREQ      (   85)  //unit in Hz
#define AUDIO_EFFECT_PARAM_VB_INTENSITY        (    3)  //unit in percent
