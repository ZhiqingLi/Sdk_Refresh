...
#define FUNC_WIFI_ALEXA_DEMO_EN	 			//打开此宏定义，支持亚马逊多国语言演示项目

//****************************************************************************************
//					WiFi产品的相关定制参数设置
//****************************************************************************************
//**MCU+CAP+PRJproject_name&:MCU+SID+name&:名称设置
#if defined(FUNC_WIFI_DUMI_PROJECT_EN)
	#define MCU_CAP_PRJ_PROJECT_NAME	"Wood_Rhythm_I"
	#define MCU_SSID_NAME	"DuerOS_MK"
	
#else
	#if defined(FUNC_WIFI_ALEXA_DEMO_EN)
		#define MCU_CAP_PRJ_PROJECT_NAME	"Wood_Rhythm_II"
		#define MCU_SSID_NAME	"Wood Rhythm II"
	#else
		#define MCU_CAP_PRJ_PROJECT_NAME	"Wood_Rhythm_I"
		#define MCU_SSID_NAME	"MK_Wood Rhythm I"
	#endif
#endif
...
#define MCU_PTV_NUM		002		//nnn为0~999的数字，表示使用的MCU 协议的版本号，默认000；此项设定和capacity 的位定义有依赖关系?
	...
	#define MCU_ALI_PID_PRODUCTID	"FREESON_ENTERTAINMENT_ATALK_MK"	//如果这是一个阿里小智的项目，请回复此项，productid来自阿里提供的prodconf.json文件里面model字段，例如：EDIFIER_ENTERTAINMENT_ATALK_MA1
