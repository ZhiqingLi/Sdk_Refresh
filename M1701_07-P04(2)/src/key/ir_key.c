...
//	PDS(按键开始)		SPR(短按松开)		CPS(长按开始)		  CPH(长按保持)		CPR(长按松开)
	{MSG_NONE,			MSG_VOL_DW, 			MSG_VOL_DW, 			MSG_VOL_DW, 			MSG_NONE		},	//POWER
	{MSG_NONE,			MSG_NONE, 			  MSG_NONE, 		  	MSG_NONE, 			  MSG_NONE		},	//MODE
	{MSG_NONE,			MSG_VOL_UP, 			MSG_VOL_UP, 	  	MSG_VOL_UP, 			MSG_NONE		},	//MUTE	
	...
	{MSG_NONE,			MSG_PLAY_PAUSE, 	MSG_STOP, 			  MSG_STOP,	 		    MSG_NONE		},	//PLAY/PAUSE

	{MSG_NONE,			MSG_WIFI_MIC, 		MSG_WIFI_WPS, 		MSG_WIFI_WPS,     MSG_NONE		},	//VOL+
	{MSG_NONE,			MSG_WIFI_TALK, 		MSG_NONE, 			  MSG_NONE, 			  MSG_NONE		},	//VOL-
	{MSG_NONE,			MSG_MODE, 			  MSG_NONE,       	MSG_NONE,	        MSG_NONE		},	//EQ
