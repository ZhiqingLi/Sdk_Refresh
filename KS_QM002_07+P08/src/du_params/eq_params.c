...
//EQ style: KS_QM002
static const EqFilterParams _EqStyle10[5] = 
{
	{ 0x0000, 0x00b4, 0x059a, 0x0397 }, // Parameters for filter 0
	{ 0x0000, 0x01f4, 0x04cd, 0x045c }, // Parameters for filter 1
	{ 0x0000, 0x09c4, 0x02cd, 0x035e }, // Parameters for filter 2
	{ 0x0000, 0x1388, 0x04cd, 0x0556 }, // Parameters for filter 3
	{ 0x0002, 0x2710, 0x039a, 0x043d }, // Parameters for filter 4
};
