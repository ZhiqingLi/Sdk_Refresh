...
#define AUDIO_EFFECT_PARAM_VB_CUTOFF_FREQ      (  105)  //unit in Hz
#define AUDIO_EFFECT_PARAM_VB_INTENSITY        (    6)  //unit in percent
...
#define AUDIO_EFFECT_PARAM_DRC_PREGAIN1        ( 5786)  //3.00dB
#define AUDIO_EFFECT_PARAM_DRC_PREGAIN2        ( 4096)  //0.00dB
#define AUDIO_EFFECT_PARAM_DRC_THRESHHOLD1     (    0)  //  4.00dB
...
#define AUDIO_EFFECT_PARAM_DRC_THRESHHOLD3     ( -300)  //  3.00dB
