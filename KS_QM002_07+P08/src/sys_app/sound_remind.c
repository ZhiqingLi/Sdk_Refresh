...
//   ID                                 中文ID                  英文ID
	...
	{SOUND_BT_INCOMING,				STR_TO_UINT("INCM"),	STR_TO_UINT("INCM")},	//有电话呼入
 	...
 	{SOUND_PWR_ON,					STR_TO_UINT("YIKJ"),	STR_TO_UINT("PWON")},	//已关机
 	...
 	{SOUND_VOL_REMIND,				STR_TO_UINT("ZDYL"),	STR_TO_UINT("ZDYL")},	//音量提示音
