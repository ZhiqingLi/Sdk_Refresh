...
//	PDS(按键开始)			SPR(短按松开)			CPS(长按开始)			CPH(长按保持)			CPR(长按松开)	
	{MSG_NONE,			MSG_VOL_UP,			MSG_NEXT, 	 		MSG_NONE, 			MSG_NONE		},	//SW1
	{MSG_NONE,			MSG_VOL_DW, 		MSG_PRE, 			MSG_NONE, 			MSG_NONE		},	//SW2
	{MSG_NONE,			MSG_MODE, 			MSG_REPEAT, 		MSG_BT_PAIR,		MSG_NONE		},	//SW3
	{MSG_NONE,			MSG_NONE,			MSG_NONE, 			MSG_NONE, 			MSG_NONE		},	//SW4
	{MSG_NONE,			MSG_NONE,			MSG_NONE, 			MSG_NONE, 			MSG_NONE		},	//SW5

	{MSG_NONE,			MSG_PRE, 			MSG_FB_START, 		MSG_FB_START, 		MSG_FF_FB_END	},	//SW6
	{MSG_NONE,			MSG_NEXT, 			MSG_FF_START, 		MSG_FF_START, 		MSG_FF_FB_END	},	//SW7
	{MSG_NONE,			MSG_EQ, 			MSG_3D,				MSG_NONE, 			MSG_NONE		},	//SW8
	{MSG_NONE,			MSG_MUTE, 			MSG_VB, 			MSG_NONE, 			MSG_NONE		},	//SW9
	...
	{MSG_NONE,			MSG_DRC,			MSG_STOP, 			MSG_NONE,			MSG_NONE		},	//SW15
