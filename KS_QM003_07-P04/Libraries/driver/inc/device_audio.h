...
#define USB_DEVICE_HID					4//PC识别为单独的HID设备
#define USB_DEVICE_AUDIO_HID			5//PC同时识别出声卡和HID设备
#define USB_DEVICE_READER_HID			6//PC同时识别出读卡器和HID设备
#define USB_DEVICE_AUDIO_READER_HID	7//PC同时识别出声卡，读卡器和HID设备
/**
 * @brief  设置USB设备工作模式
