 ...
 *   The File is Auto Generated by ACPWorkbench V8.2.1
 *              Firmware Version: EFFECT 8.2.0
 *                All Right Reserved
 *******************************************************/
...
#define AUDIO_EFFECT_PARAM_VB_CUTOFF_FREQ      (  100)  //unit in Hz
#define AUDIO_EFFECT_PARAM_VB_INTENSITY        (   35)  //unit in percent
