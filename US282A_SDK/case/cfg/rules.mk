...
# OTA版本，由 make ota 产生，增加一个宏定义OTA_VERSION，传入gcc
ifeq ($(OTA_VER), TRUE)
	CC_OPTS_BASE += -DOTA_VERSION
	CC_OPTS_BASE_16 += -DOTA_VERSION
endif

CC_OPTS_O0 = $(CC_OPTS_BASE) -O0
CC_OPTS_O0_A = $(CC_OPTS_O0) -D_ASSEMBLER_

CC_OPTS_O1 = $(CC_OPTS_BASE) -O1
CC_OPTS_O1_A = $(CC_OPTS_O1) -D_ASSEMBLER_

CC_OPTS_O2 = $(CC_OPTS_BASE) -O2
CC_OPTS_O2_A = $(CC_OPTS_O2) -D_ASSEMBLER_

CC_OPTS_Os = $(CC_OPTS_BASE) -Os
CC_OPTS_Os_A = $(CC_OPTS_O2) -D_ASSEMBLER_

CC_OPTS_O0_16 = $(CC_OPTS_BASE_16) -O0
CC_OPTS_O0_A_16 = $(CC_OPTS_O0_16) -D_ASSEMBLER_

CC_OPTS_O1_16 = $(CC_OPTS_BASE_16) -O1
CC_OPTS_O1_A_16 = $(CC_OPTS_O1_16) -D_ASSEMBLER_

CC_OPTS_O2_16 = $(CC_OPTS_BASE_16) -O2
CC_OPTS_O2_A_16 = $(CC_OPTS_O2_16) -D_ASSEMBLER_

CC_OPTS_Os_16 = $(CC_OPTS_BASE_16) -Os
CC_OPTS_Os_A_16 = $(CC_OPTS_O2_16) -D_ASSEMBLER_
