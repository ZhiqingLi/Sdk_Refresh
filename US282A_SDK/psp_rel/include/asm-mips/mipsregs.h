 ...
 *                            All Rights Reserved.
 *
 * 描述：MIPS CP0寄存器定义和CP0/FLOAT CP/DSP AS/TLB读写操作宏定义
 * 作者：liminxian
 ********************************************************************************/
...
extern int read_c0_count(void);

//#define write_c0_count(val)	__write_32bit_c0_register($9, 0, val)
extern void write_c0_count(unsigned int val);
...
extern void write_c0_compare(unsigned int val);
