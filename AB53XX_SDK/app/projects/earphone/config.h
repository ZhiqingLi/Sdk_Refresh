...
#define SOFT_POWER_ON_OFF               xcfg_cb.soft_power_on_off_en //是否使用软开关机功能
...
#define BT_HFP_SIRI_CMD_EN              1   //是否支持语音助手（Siri）命令，android需要在语音助手中打开“蓝牙耳机按键启动”, ios需要打开siri功能
...
#define DAC_OFF_FOR_BT_CONN_EN          xcfg_cb.dac_off_for_conn        //蓝牙连接时是否关闭dac（仅对差分输出有效）
