...
//        break;
    ...
    case KU_SIRI:
        if(xcfg_cb.bt_siri_key_sel == 0) {
            bt_siri_switch();
        }
        break;
    case KD_SIRI:
        if(xcfg_cb.bt_siri_key_sel == 1) {
            bt_siri_switch();
        }
        break;
    case KL_SIRI:
        if(xcfg_cb.bt_siri_key_sel == 2) {
            bt_siri_switch();
        }
        break;
    ...
    case KL_PLAY_POWER:
        f_bt.siri_kl_flag = 1;
        break;
    case KLU_PLAY_POWER:        //PWRKEY用抬键消息
        if(f_bt.siri_kl_flag == 0) {
            break;
        }
        f_bt.siri_kl_flag = 0;
    case KL_PLAY_HSF:
        if(xcfg_cb.bt_siri_ctrl_en == 1) {
            bt_siri_switch();
        }
        break;
