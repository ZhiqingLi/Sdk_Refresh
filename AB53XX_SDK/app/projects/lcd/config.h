...
#define GUI_SELECT                      GUI_LCD                 //GUI Display Select
...
#define MUSIC_WMA_SUPPORT               1   //是否支持WMA格式解码
#define MUSIC_APE_SUPPORT               1   //是否支持APE格式解码
#define MUSIC_FLAC_SUPPORT              1   //是否支持FLAC格式解码
...
#define MUSIC_LRC_EN                    1   //是否支持歌词显示
