...
{
#if REC_AUTO_PLAY
    ledseg_buf[0] = ledseg_num_table[rec_play_cb.curtime.min / 10];
    ledseg_buf[1] = ledseg_num_table[rec_play_cb.curtime.min % 10];
    ledseg_buf[2] = ledseg_num_table[rec_play_cb.curtime.sec / 10];
    ledseg_buf[3] = ledseg_num_table[rec_play_cb.curtime.sec % 10];
