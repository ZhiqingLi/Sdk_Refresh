...
#include "sfr.h"
    ...
    #define SD_DAT_MUX_IS_ONLINE()  ((GPIOA & BIT(7)) == 0)
    ...
    #define SD_DAT_MUX_IS_ONLINE()  ((GPIOB & BIT(2)) == 0)
    ...
    #define SD_DAT_MUX_IS_ONLINE()  ((GPIOE & BIT(7)) == 0)
    ...
    #define SD_CMD_MUX_IS_ONLINE()  ((GPIOA & BIT(5)) == 0)
    #define SD_DAT_MUX_IS_ONLINE()  ((GPIOB & BIT(4)) == 0)
    ...
    #define SD_CMD_MUX_IS_ONLINE()  ((GPIOA & BIT(5)) == 0)
    #define SD_DAT_MUX_IS_ONLINE()  ((GPIOB & BIT(3)) == 0)
