...
const char dir_spf_sfn_exfat[8] = {0x53, 0x50, 0x46, 0x55, 0x5F, 0xF3, 0x97, '\0'};
...
#if BT_APP_EN
    bsp_app_rec_play_time(1, rec->tm_sec);
#endif
