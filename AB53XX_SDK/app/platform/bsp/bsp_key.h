...
#define EVT_ECHO_LEVEL          0x7ee
#define EVT_MIC_VOL             0x7ed
#define EVT_MUSIC_VOL           0x7ec
#define EVT_A2DP_VOL_2_PHONE    0x7eb
#define EVT_KEY_2_UNMUTE        0x7ea
#define EVT_MIC_INSERT          0x7e9
#define EVT_MIC_REMOVE          0x7e8
#define EVT_TWS_HID_SHUTTER     0x7e7
#define EVT_TREM_LEVEL          0x7e6
#define EVT_BASS_LEVEL          0x7e5
#define EVT_BT_SET_LANG_ID      0x7e4
#define EVT_BT_SET_EQ           0x7e3
#define EVT_BT_APP              0x7e2
#define EVT_SD1_INSERT          0x7e1
#define EVT_SD1_REMOVE          0x7e0
...
#define KEY_VOICE_RM            KEY_25      //一键消人声
#define KEY_SIRI                KEY_26
