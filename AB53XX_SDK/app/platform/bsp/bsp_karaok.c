...
void bsp_karaok_init(u8 path, u8 func)
{
    ...
    //karaok_enable_mic_first(0x2000);   //mic_first时，音乐音量固定为0x2000, (数字音量最大值为0xFFFF_65535)
    karaok_enable_mic_first_percent(10); //百分比，10表示mic_first音乐音量是正常音乐音量的10%。
