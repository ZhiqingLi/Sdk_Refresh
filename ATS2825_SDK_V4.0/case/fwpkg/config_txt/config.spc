...
key=SETTING_ONOFF_POWEROFF_SWITCH_MODE;
type=DATA;
operate=SINGLE;
len=;
RANGE=0,1;
tab_layer1_name=common_parameters; 
tabname =setting;
RANGE_DISP_EN=0:hardware,1:software;  
RANGE_DISP_CH=0:硬开关,1:软开关;
DISP_EN=poweoff mode:0:hardware,1:software. 
DISP_CH=开关机模式:0表示硬开关；1表示软开关
DISPLAY=1;
...
RANGE=0,1;
tabname=btmanager;
RANGE_DISP_EN=1:support siri:,0:don't support siri;
RANGE_DISP_CH=1:支持siri,0:不支持siri;
DISP_EN=support tip:1-support siri,0-don't support siri
DISP_CH=支持SIRI:1-支持siri，0-不支持siri
DISPLAY=0;

key=BTMANAGER_ENABLE_MSBC;
type=DATA;
operate=SINGLE;
len=;
RANGE=0,1;
tabname=btmanager;
RANGE_DISP_EN=1:support msbc:,0:don't support siri;
RANGE_DISP_CH=1:支持MSBC,0:不支持MSBC;
DISP_EN=support tip:1-support MSBC,0-don't support MSBC
DISP_CH=支持MSBC:1-支持MSBC，0-不支持MSBC
DISPLAY=1;
