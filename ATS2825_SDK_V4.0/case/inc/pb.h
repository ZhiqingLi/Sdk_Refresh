...
#define PB_DECODE_SECTION __section__(".pb_decode")
#define PB_DECODE_COMMON  __section__(".pb_decodecomm")
#define PB_ENCODE_SECTION __section__(".pb_encode")

#define ENABLE_AUTO_LOAD_RODATA
