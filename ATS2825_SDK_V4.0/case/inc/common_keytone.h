...
#define KEYTONE_TALK_START     4  //与Alexa对话开始
#define KEYTONE_MIC_MUTE       5  //MIC MUTE
#define KEYTONE_MIC_UNMUTE     6  //MIC UNMUTE

#define KEYTONE_SAMPLE_RATE    8  //8K采样率
#define KEYTONE_FILELIST_MAX   7
#define KEYTONE_FILENAME_LEN   14
