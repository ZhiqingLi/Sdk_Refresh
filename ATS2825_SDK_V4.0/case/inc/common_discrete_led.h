...
#define LED_BL_LINK_PORT     LED_PORT_GPIOA
#define LED_BL_LINK_PIN      (22)

#define LED_POWER_PORT       LED_PORT_GPIOB
#define LED_POWER_PIN        (9)
#elif defined(BOARD_LINKPLAY_DEMO) || defined(BOARD_LINKPLAY_FAR_DEMO)
//no led to show
#define LED_MIC_MUTE_PORT    LED_PORT_GPIOA
#define LED_MIC_MUTE_PIN     (12)

#define LED_BL_LINK_PORT     LED_PORT_GPIOA
#define LED_BL_LINK_PIN      (4)
#elif defined(BOARD_DPI_7C370_FAR) || defined(BOARD_JL_36410_FAR)
#define LED_MIC_MUTE_PORT    LED_PORT_GPIOA
#define LED_MIC_MUTE_PIN     (13)

#define LED_BL_LINK_PORT     LED_PORT_GPIOA
#define LED_BL_LINK_PIN      (14)

#define LED_AUX_PLAY_PORT    LED_PORT_GPIOA
#define LED_AUX_PLAY_PIN     (12)
#else
...
#define LED_RESERVE_ENABLE_SHIFT             (0)
#define LED_RESERVE_ENABLE_MASK              (1 << LED_RESERVE_ENABLE_SHIFT)
#define LED_RESERVE_ENABLE_CTL               (0 << LED_RESERVE_ENABLE_SHIFT)
#define LED_RESERVE_DISABLE_CTL              (1 << LED_RESERVE_ENABLE_SHIFT)
...
extern void discrete_led_disable(led_port_e id, uint8 state) __FAR__;
extern void discrete_led_enable(led_port_e id) __FAR__;
