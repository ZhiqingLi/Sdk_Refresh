...
extern int com_btmanager_avrcp_op_async(btplay_avrcp_opid_e opid, uint8 bForce) __FAR__;
...
#ifdef ENABLE_DOUBLE_PHONE_
    BTCALL_HFP_HANGUP_SPECIAL_CALL,     /* 3 */
    BTCALL_HFP_HANGUP_OLD_CALL,         /* 4 */
#endif
    BTCALL_HFP_MAX_REQ,
} btcall_hfp_req_e;
...
extern int com_btmanager_sppble_copy_rcp(uint8 *rcp_buf, uint16 data_len) __FAR__;
#endif
