...
typedef struct {
    ...
    key_op_i __key_dae_filter_ctl;
    key_op_i __key_i2c_write;
    key_op_i __key_i2c_read;
    key_op_i __key_i2c_read_write;
    key_op_i __key_spi_write;
    key_op_i __key_spi_read;
    key_op_i __key_spi_read_write;
#if defined(ENABLE_ALEXA_LED_NOTIFY)
    key_op_i __key_alexa_led_show;
#endif
...
block_key_operations blk_op = {
    ...
    (key_op_i)key_inner_dae_filter_ctl,
    (key_op_i)key_inner_i2c_write,
    (key_op_i)key_inner_i2c_read,
    (key_op_i)key_inner_i2c_read_write,
    (key_op_i)key_inner_spi_write,
    (key_op_i)key_inner_spi_read,
    (key_op_i)key_inner_spi_read_write,
#if defined(ENABLE_ALEXA_LED_NOTIFY)
    (key_op_i)key_inner_alexa_led_show,
#endif
};
