...
#define INDEX_INTERFACE_CTRL           0x0000
#define INDEX_INTERFACE_PLAY           0x0001
#define INDEX_INTERFACE_RECORD         0x0002
#define INDEX_INTERFACE_HID            0x0003
...
typedef struct {
    ...
    uint8 baInterfaceNr1; /*Interface number of the first AudioStreaming or MIDIStreaming interface
     in the Collection.*/
#ifdef _USB_RECORD_
    uint8 baInterfaceNr2; /*Interface number of the second AudioStreaming or MIDIStreaming interface
     in the Collection.*/
#endif
...
typedef struct {
    ...
    Audio_Class_Selector_t Audio_Class_Selector;
#endif
...
typedef struct {
    ...
    uint8 bSamFreqType; //N frequency supported.
    uint8 tSamFreq1[3]; //Sample frequency.
} Format_Type_Descriptor_sub_t; //Table B-10: USB Microphone Type I Format Type Descriptor
...
typedef struct {
    ...
    ClassSpecific_AS_Interface_Descriptor_t Audio_Class_General_Setting1;
    //Format_Type_Descriptor_t Audio_Class_Format_Setting1;
    Format_Type_Descriptor_sub_t Audio_Class_Format_Setting1;
    Standard_Endpiont_Descriptor_t Endpoint_Descriptor_Setting1;
    ClassSpecific_Endpiont_Descriptor_t Audio_Data_Endpoint_Setting1;
    ...
    ClassSpecific_AS_Interface_Descriptor_t Audio_Class_General_Setting2;
    //Format_Type_Descriptor_t Audio_Class_Format_Setting2;
    Format_Type_Descriptor_sub_t Audio_Class_Format_Setting2;
    Standard_Endpiont_Descriptor_t Endpoint_Descriptor_Setting2;
    ClassSpecific_Endpiont_Descriptor_t Audio_Data_Endpoint_Setting2;
#endif
    ...
    Standard_HID_Descriptor_t HID_Descriptor_Setting0;
    Standard_Endpiont_Descriptor1_t Endpiont_Descriptor_Setting3;
} device_audio_configuration_sub_t;
