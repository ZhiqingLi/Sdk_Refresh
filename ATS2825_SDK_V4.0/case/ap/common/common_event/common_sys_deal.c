...
app_result_e com_smart_deal_hfp_call(void);
...
const sys_event_map_t __section__(".rodata.se_maplist") com_se_maplist[] = {
    ...
    { { MSG_BT_HFP_CALL, SYSMSG_STOP_TTS_YES }, com_smart_deal_hfp_call },
#else
...
#if defined(SMART_BOX_BUF_MODE) || defined(SMART_BOX_OPUS_MODE)
    { { MSG_SMART_VOICE_TRIGGER, SYSMSG_STOP_TTS_YES}, lp_alexa_voice_trigger},
#endif
    /*! 结束标志 */
    { { MSG_NULL, 0 }, NULL },
};
