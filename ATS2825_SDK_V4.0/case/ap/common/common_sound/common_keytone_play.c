...
#ifdef KEYTONE_VOLUME_SAME_AS_SYSTEM_VOLUME
    kt_play_info.kt_compact = 0x0600 + 0x9EC * sys_comval->volume_current / 31;
#else
...
void __section__(".keytone.bank") com_start_key_tone(uint8 mode)
{
    //按键音使能，才发出按键音
