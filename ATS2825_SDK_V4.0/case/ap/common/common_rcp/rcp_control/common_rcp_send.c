...
/*发送rcp命令包*/
void com_rcp_send_cmd_pkg(uint8 *data_ptr, uint16 length)
{

    g_rcp_service_type = RCP_ACT_SERV_FLAG;
    g_rcp_remote_number = 0;

    com_btmanager_sppble_send(data_ptr, length);
}
