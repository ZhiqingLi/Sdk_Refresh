...
app_result_e key_play_deal(void)
{
    ...
    if(lp_get_alexa_alarm_state() == ALEXA_ALARM_STATE_PLAYING) {
        lp_stop_alexa_alarm();
        return RESULT_NULL;
    }

    if(lp_alexa_key_play_deal() == LP_SDK_ERR_SUCCESS)
        return RESULT_NULL;
#endif
...
app_result_e key_next_deal(void)
{
    ...
    if(lp_alexa_key_next_deal() == LP_SDK_ERR_SUCCESS) {
        return RESULT_NULL;
    }
#endif
...
app_result_e key_prev_deal(void)
{
    ...
    if(lp_alexa_key_prev_deal() == LP_SDK_ERR_SUCCESS)
        return RESULT_NULL;
#endif
