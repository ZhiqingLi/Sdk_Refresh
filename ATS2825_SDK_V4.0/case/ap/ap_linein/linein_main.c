...
int main(int argc, const char *argv[])
{
    ...
    discrete_led_disable(LED_ID_BT_LINK, 0);
#endif
#if (CASE_BOARD_TYPE == CASE_BOARD_DEMO) || defined(BOARD_DPI_7C370_FAR) || defined(BOARD_JL_36410_FAR)
...
#if defined(BOARD_DPI_7C370_FAR) || defined(BOARD_JL_36410_FAR)
    discrete_led_enable(LED_ID_BT_LINK);
#endif
#if (CASE_BOARD_TYPE == CASE_BOARD_DEMO) || defined(BOARD_DPI_7C370_FAR) || defined(BOARD_JL_36410_FAR)
