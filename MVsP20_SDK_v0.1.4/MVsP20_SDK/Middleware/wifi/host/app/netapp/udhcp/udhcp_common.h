...
#ifdef UDHCP_DBG
#define UDHCP_DEBUG LOG_PRINTF
#else
#define UDHCP_DEBUG udhcp_printf
extern void udhcp_printf(const char *fmt, ...);
#endif
...
#define xmalloc OS_MemAlloc
//#define xrealloc realloc
//#define xstrdup  strdup
#define safe_strncpy strncpy
#define xzalloc OS_MemAlloc

#define MAIN_EXTERNALLY_VISIBLE
#define UNUSED_PARAM
#define NOINLINE 
#define ALIGNED(a)
#define bb_info_msg UDHCP_DEBUG
#define bb_error_msg UDHCP_DEBUG
#define bb_error_msg_and_die UDHCP_DEBUG
#define bb_perror_msg UDHCP_DEBUG
...
STRUCT_PACKED struct dhcp_packet {
