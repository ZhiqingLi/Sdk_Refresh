...
MUSB_DeviceDriver* MUSB_GetStorageClassDriver()
{
...
static MGC_MsdDevice* MGC_MsdDeviceInit(MUSB_Device* pUsbDevice)
{
	...
	os_printf("MGC_MsdDeviceInit is called\r\n");
...
//	os_printf("MUSB_MsdConnect Function is called\r\n");
    /* assume first config */
...
//    uint32_t                  dwStatus;  
	...
	os_printf("MGC_MsSetConfigCallback fun is called\r\n");
