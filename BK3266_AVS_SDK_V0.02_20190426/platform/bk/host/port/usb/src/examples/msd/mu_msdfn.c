...
STATIC void MGC_MsdNewUsbState(void* hClient, MUSB_BusHandle hBus, 
			       MUSB_State State)
{
    //os_printf("MGC_MsdNewUsbState:state=%x\r\n",State);
...
#if 0
    const MGC_MsdCommand10* pCommand10;
    const MGC_MsdCommand12* pCommand12;
#endif
...
#if 0
    pCommand10 = (const MGC_MsdCommand10*)&(pCbw->aCbwCb[0]);
    pCommand12 = (const MGC_MsdCommand12*)&(pCbw->aCbwCb[0]);
#endif
    switch(bOpcode)
    {
