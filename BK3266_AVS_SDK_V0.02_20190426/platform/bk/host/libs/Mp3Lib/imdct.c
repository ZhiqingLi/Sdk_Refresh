 ...
 **************************************************************************************/
static void MP3_CALL AntiAlias(int *x, int nBfly)
{
	int k, a0, b0, c0, c1;
	const int *c;
 ...
 **************************************************************************************/
static void MP3_CALL WinPrevious(int *xPrev, int *xPrevWin, int btPrev)
{
 ...
 **************************************************************************************/
static int MP3_CALL FreqInvertRescale(int *y, int *xPrev, int blockIdx, int es)
{
	int i, d, mOut;
...
static void MP3_CALL idct9(int *x)
{
 ...
 **************************************************************************************/
static int MP3_CALL IMDCT36(int *xCurr, int *xPrev, int *y, int btCurr, int btPrev, int blockIdx, int gb)
{
 ...
 */
static void MP3_CALL imdct12 (int *x, int *out)
{
	int a0, a1, a2;
 ...
 **************************************************************************************/
static int MP3_CALL IMDCT12x3(int *xCurr, int *xPrev, int *y, int btPrev, int blockIdx, int gb)
{
 ...
 **************************************************************************************/
static int MP3_CALL HybridTransform(int *xCurr, int *xPrev, int y[BLOCK_SIZE][NBANDS], SideInfoSub *sis, BlockCount *bc)
{
 ...
 **************************************************************************************/
int MP3_CALL IMDCT(MP3DecInfo *mp3DecInfo, int gr, int ch)
{
