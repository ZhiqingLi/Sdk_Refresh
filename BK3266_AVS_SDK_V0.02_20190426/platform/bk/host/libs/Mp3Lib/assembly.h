...
#if 0
#define MULSHIFT32	MULSHIFT32_ASM
extern __inline int MULSHIFT32(int x, int y);
#else
...
#define MADD64	MADD64_ASM
extern __inline Word64 MADD64(Word64 sum, int x, int y);

#define SAR64 SAR64_ASM
extern __inline Word64 SAR64(Word64 x, int n);
