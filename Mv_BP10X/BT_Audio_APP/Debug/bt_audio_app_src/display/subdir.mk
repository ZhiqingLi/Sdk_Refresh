...
C_SRCS += \
../bt_audio_app_src/display/display.c \
../bt_audio_app_src/display/seg_led_disp.c \
../bt_audio_app_src/display/seg_panel.c 

OBJS += \
./bt_audio_app_src/display/display.o \
./bt_audio_app_src/display/seg_led_disp.o \
./bt_audio_app_src/display/seg_panel.o 

C_DEPS += \
./bt_audio_app_src/display/display.d \
./bt_audio_app_src/display/seg_led_disp.d \
./bt_audio_app_src/display/seg_panel.d 


# Each subdirectory must supply rules for building sources it contributes
bt_audio_app_src/display/%.o: ../bt_audio_app_src/display/%.c
	@echo '正在构建文件： $<'
