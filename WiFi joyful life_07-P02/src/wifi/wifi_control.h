...
{	
	...
	WIFI_PLAY_MODE_ALIAPP_PLAY = 22,	//阿里项目通过阿里APP点击播放
...
{	
	...
	uint16_t MicState; //MIC状态（000 空闲 001 录音中  002 语义识别中  003 语音回复中 004 MIC错误  FFF MIC禁止 ）
...
#ifdef FUNC_WIFI_POWER_KEEP_ON
extern void OtherModulePlayWiFiSoundRemind(void);
#endif
