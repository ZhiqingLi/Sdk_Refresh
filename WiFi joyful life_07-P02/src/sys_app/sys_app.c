...
#ifdef FUNC_BREAKPOINT_EN
{
	...
	gSys.CS3310Volume = 10;            //客户要求音量设置为30%
#else
	gSys.CS3310Volume = BP_GET_ELEMENT(pBpSysInfo->CS3310Volume);
#endif
	gSys.Volume = MAX_VOLUME;
	if(gSys.CS3310Volume > MAX_VOLUME || gSys.CS3310Volume < 7)
	{
		gSys.CS3310Volume = 7;
	}
#else
	...
	APP_DBG("SysVarInit gSys.CurModuleID = %d\n", gSys.CurModuleID);
...
#ifdef FUNC_DIGITAL_VOLUME_ADJ_EN
	pBpSysInfo->CS3310Volume = gSys.CS3310Volume;
#endif
