...
typedef enum _OUTPUT_CHANNEL_SELECT
{
	DAC_OUTPUT_CHANNEL = 0,
	I2S_OUTPUT_CHANNEL,
	DAC_I2S_OUTPUT_CHANNEL,
	CLASSD_OUTPUT_CHANNEL,
	DAC_CLASSD_OUTPUT_CHANNEL
...
typedef struct _SYS_INFO_
{
	...
	uint8_t CS3310Volume;
	uint16_t CurAudioChannel;
	uint16_t NextAudioChannel;
#endif
	uint8_t MuteFlag;
	uint8_t Eq;
