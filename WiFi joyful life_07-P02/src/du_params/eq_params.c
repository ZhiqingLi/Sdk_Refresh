...
//EQ style: Classical
static const EqFilterParams _EqStyle0[5] = 
{
	...
	{ 0x0000, 0x0626, 0x0125, 0x04a8 }, // Parameters for filter 4
	{ 0x0002, 0x1124, 0x02d4, 0x03a1 }, // Parameters for filter 5
};
