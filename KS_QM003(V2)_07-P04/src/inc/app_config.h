...
//#define WIFI_MIC_PORT_BIT				GPIOA23
#endif
...
//	#define FUNC_AMP_POWER_EN
		...
		#define AMP_MUTE_PORT_OUT				GPIO_B_OUT
		#define AMP_MUTE_PORT_BIT				GPIOB25
...
//	#define FUNC_BT_EN											//蓝牙功能
		...
		#define BT_DEVICE_NAME		"SN_160W"					// 蓝牙设备名
...
//	#define USE_POWERKEY_SOFT_PUSH_BUTTON       //for soft push button case ONLY
	...
	#define OPTION_CHAR_FUL_DETECT              //打开该宏定义，支持GPIO检测充电设备插入功能
			...
			//充满电检测端口配置
			#define CHAR_FUL_DETECT_PORT_PU			GPIO_C_PU
			#define CHAR_FUL_DETECT_PORT_PD			GPIO_C_PD
			#define CHAR_FUL_DETECT_PORT_IN			GPIO_C_IN
			#define CHAR_FUL_DETECT_PORT_IE			GPIO_C_IE
			#define CHAR_FUL_DETECT_PORT_OE			GPIO_C_OE
...
//	#define FUNC_IIC_KEY_EN   								//IIC 从机按键
		...
		#define I2C_KEY_SCL_PORT_OUT			GPIO_B_OUT		
		#define I2C_KEY_SCL_PORT_BIT		  GPIOB25		
		#define I2C_KEY_SDA_PORT_OUT		  GPIO_B_OUT	    
		#define I2C_KEY_SDA_PORT_BIT			GPIOB24	     	
	#endif
...
//	#define FUNC_9PIN_SEG_LED_EN			//9只脚的段码LED 屏
...
//	#define FUNC_AIP1629A_LED_EN            //AIP1629LED段码驱动IC
	...
	#define  LED_WHITE_MODE_ON()      	do{\
										PwmConfig(LED_RED_PWM_PORT_MASK, 1200, 1200);\
										PwmEnableChannel(LED_RED_PWM_PORT_MASK, PWM_IO_SEL1, PWM_MODE_OUT);\
										PwmConfig(LED_GREEN_PWM_PORT_MASK, 1200, 720);\
										PwmEnableChannel(LED_GREEN_PWM_PORT_MASK, PWM_IO_SEL1, PWM_MODE_OUT);\
										PwmConfig(LED_BLUE_PWM_PORT_MASK, 1200, 720);\
										PwmEnableChannel(LED_BLUE_PWM_PORT_MASK, PWM_IO_SEL1, PWM_MODE_OUT);\
										}while(0)
	...
	#define LED_WHITE_MODE_ON()
	#define LED_WHITE_MODE_OFF()
	#define LED_ORANGE_MODE_ON()
	#define LED_YELLOW_MODE_ON()
	#define LED_PURPLE_MODE_ON()
	#define LED_CYAN_MODE_ON()
	#define LED_ALL_MODE_OFF()
#endif
