...
#define  FUNC_APP_DEBUG_EN
	...
	#define APP_DEBUG_UART_GPIO_SEL		1				    
...
//GPIO按键定义
	#define FUNC_GPIO_KEY_EN   						//GPIO按键
		...
		#define 	GPIO_KEY1_PORT_BIT				3	

		#define 	GPIO_KEY2_PORT_OUT				GPIOB0		
		#define 	GPIO_KEY2_PORT_BIT				2	
	#endif
...
//PWM0 配置
	#define FUNC_PWM0_OUT_EN								//PWM0宏开关
		...
		#define		FUNC_PWM0_GPIO_PORT	GTC0_PWMPIN_GPIOC3	//如果只使用1路ADC按键，则保留本行
...
//PWM1 配置
	#define FUNC_PWM1_OUT_EN								//PWM1宏开关
		...
		#define		FUNC_PWM1_GPIO_PORT	GTC1_PWMPIN_GPIOC2	//如果只使用1路ADC按键，则保留本行
		//PWM输出功能配置：重载、PWM使能、输出有效状态
...
//PWM2 配置
	#define FUNC_PWM2_OUT_EN								//PWM2宏开关
		...
		#define		FUNC_PWM2_GPIO_PORT	GTC2_PWMPIN_GPIOC1	//如果只使用1路ADC按键，则保留本行
		//PWM输出功能配置：重载、PWM使能、输出有效状态
...
//	#define FUNC_PWM3_OUT_EN								//PWM3宏开关
		...
		#define		FUNC_PWM3_GPIO_PORT	GTC0_PWMPIN_GPIOC3	//如果只使用1路ADC按键，则保留本行
		//PWM输出功能配置：重载、PWM使能、输出有效状态
