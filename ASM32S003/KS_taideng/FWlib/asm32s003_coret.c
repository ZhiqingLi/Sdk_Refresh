...
volatile U32_T CORET_Systick_Count = 0;			//CORET Systick count
/* externs--------------------------------------------------------------------*/
...
/*************************************************************/
// CORET Systick count check;
//EntryParameter:NONE
//ReturnValue:NONE
/*************************************************************/
void CORET_Systick_Check(void)
{
	static U32_T PrevSystickCount = 0;
	
	if((CORET_Systick_Count%3600000/60000) != PrevSystickCount)
	{
		PrevSystickCount = (CORET_Systick_Count%3600000/60000);
		APP_DBG("Runing SysTick: %d hour:%d min;\n", CORET_Systick_Count/3600000, (CORET_Systick_Count%3600000)/60000);
	}
}
