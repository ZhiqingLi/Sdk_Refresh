...
void SYSCON_General_CMD(FunctionalStatus NewState, SYSCON_General_CMD_TypeDef ENDIS_X )
{
	if (NewState != DISABLE)
	{
		...
		GPIOA0->CONLR=(GPIOA0->CONLR & 0XFFFFF00f)|0x00000660;					//使能对应PIN
...
void SystemCLK_HCLKDIV_PCLKDIV_Config(SystemCLK_TypeDef SYSCLK_X , SystemCLK_Div_TypeDef HCLK_DIV_X , PCLK_Div_TypeDef PCLK_DIV_X)
{
	...
	if(SYSCLK_X==SYSCLK_EMOSC) GPIOA0->CONLR=(GPIOA0->CONLR & 0XFFFFF00f)|0x00000660;					//使能对应PIN
}
/*************************************************************/
...
//ReturnValue:NONE
/*************************************************************/
void SYSCON_PWRCR_CONFIG(U32_T PWRCR_dat)
{
