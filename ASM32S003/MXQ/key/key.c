...
#if (defined(FUNC_ADC_KEY_EN) || defined(FUNC_IR_KEY_EN) || defined(FUNC_CODING_KEY_EN) || defined(FUNC_GPIO_KEY_EN)) || defined(FUNC_IIC_KEY_EN) || defined(FUNC_GPIO_ON_OFF_EN)
#ifdef FUNC_ADC_KEY_EN
extern void AdcKeyInit(void);
extern uint16_t AdcKeyScan(void);
extern B_T GetAdcKeyState(void);
#endif

#ifdef FUNC_IR_KEY_EN
extern void IrKeyInit(void);
extern uint16_t IrKeyScan(void);
extern B_T GetIrKeyState(void);
#endif
