...
#define LIGHT_PWM_CHANGE_CNT	200						//??¡ä?¦Ì¡Â??¨¢¨¢?¨¨¦Ì?¨º¡À??????¡ê?¦Ì£¤??mS
#define POWER_OFF_WAIT_TIME 	5000					//1??¨²¦Ì¨¨¡äy¨º¡À??¡ê?¦Ì£¤??mS
...
int main(void)
{
	...
	while(1)
	{
        ...
        if(Msg != MSG_NONE)
        {
            ...
            TimeOutSet(&KeyMsgScanTimer, 300);
        ...
        //¡ã¡ä?¨¹3?¨º¡Ào¨®¡ê?D¨¨¨°a??3y¡ê?¡¤¨¤?1?¡Â?¨²¨°??¡À?¨¢¦Ì?¡ã¡ä?¨¹?¦Ì
        if (IsTimeOut(&KeyMsgScanTimer))
        {
            I2CWrBuffer[KEY_MSG_BASE] = MSG_NONE;
        }
