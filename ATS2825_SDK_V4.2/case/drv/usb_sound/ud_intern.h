...
#define    RECORD_BUFF_SIZE     0x800
#define    RECORD_HIGH_THRESHOLD 0x700
#define    RECORD_LOW_THRESHOLD  0x500
...
extern uint8 g_rec_no_up[RECORD_BUFF_SIZE];

#endif

//extern uint32 prev_freq;
//extern uint8 g_mic_config_val;
extern uint8 g_no_empty_count;
//for volume chg
extern uint8 g_fix_sample_flg;
...
extern uint32 g_play_data_count;

extern uint32 g_no_data_count;

extern uint32 g_manul_stop;
extern  uint32 low_energy;
#ifdef _USB_RECORD_

extern uint32 g_start_record;

extern uint32 g_wr_record_ptr;

extern uint32 g_rd_record_ptr;

extern uint32 g_record_data_count;

extern uint32 g_record_packet_size;
//extern uint32 record_sample;
#endif
...
extern uint32 g_adc_sample;

extern uint32 g_dac_sample;

extern uint8 g_cur_selector;

extern uint8 g_set_sample_flag;
extern uint8 g_set_adc_sample_flag;
extern uint8 g_set_dac_sample_flag;
...
extern uint8 g_set_adc_enable;

//extern device_audio_configuration_t All_Descriptors_of_Configuration;
extern uint8 audio_descriptors_of_configuration[sizeof(device_audio_configuration_t)];

extern uint8 g_audio_config_data_size;

//extern void* g_audio_config_data_ptr;

extern uint8 g_audio_sample_set;
...
extern uint8 g_set_rate[3];

extern uint8  g_asrc_adj_flag;
...
extern uint8 g_tts_start_flag;

extern uint8 g_pc_switch_flag;

extern uint8 g_reset_flag;

extern const device_audio_configuration_t All_Descriptors_of_Configuration1;

extern const device_audio_configuration_sub_t All_Descriptors_of_Configuration2;
...
extern void cap_adc_dma_stop(void) __FAR__;

extern void cap_adc_dma_isr(void) __FAR__;
...
extern void usb_data_buffer_malloc(void) __FAR__;

extern void usb_data_buffer_free(void) __FAR__;
