...
#define drv_pb_istream_from_buffer(buf, bufsize, stream) \
    lcd_op_entry((void *)(buf), (void *)(bufsize), (void *)(stream), LED_PB_FUNC0)

#define drv_pb_decode(stream, fields, dest_struct) \
    (uint32)lcd_op_entry((void *)(stream), (void *)(fields), (void *)(dest_struct), LED_PB_FUNC1)

#define drv_pb_ostream_from_buffer(buf, bufsize, stream) \
    lcd_op_entry((void *)(buf), (void *)(bufsize), (void *)(stream), LED_PB_FUNC2)

#define drv_pb_encode(stream, fields, src_struct) \
    (uint32)lcd_op_entry((void *)(stream), (void *)(fields), (void *)(src_struct), LED_PB_FUNC3)

#define drv_pb_register_callback(callback) \
    lcd_op_entry((void *)(callback), (void *)(0), (void *)(0), LED_PB_FUNC4)
