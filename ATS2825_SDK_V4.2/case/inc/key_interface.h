...
#define key_dae_filter_ctl(a) (int32)key_op_entry((void*)(uint32)(a), (void*)(0), (void*)(0), KEY_DAE_FILTER_CTL)
...
#define key_i2c_write(addr, buf, size) \
    (int)key_op_entry((void *)(uint32)addr, (void*)(uint32)buf, (void*)size, KEY_I2C_WRITE)

#define key_i2c_read(addr, buf, size) \
    (int)key_op_entry((void *)(uint32)addr, (void*)(uint32)buf, (void*)size, KEY_I2C_READ)

#define key_i2c_read_write(addr, buf, wsize, rsize) \
    (int)key_op_entry((void *)(uint32)addr, (void*)(uint32)buf, (void *)((rsize << 16) | wsize), KEY_I2C_READ_WRITE)


#define key_spi_write(buf, size) \
    (int)key_op_entry((void *)(uint32)buf, (void *)size, (void *)0, KEY_SPI_WRITE)

#define key_spi_read(buf, size) \
    (int)key_op_entry((void *)(uint32)buf, (void *)size, (void *)0, KEY_SPI_READ)

#define key_spi_read_write(wbuf, wsize, rbuf, rsize) \
    (int)key_op_entry((void *)(uint32)wbuf, (void *)(uint32)rbuf, (void *)((rsize << 16) | wsize), KEY_SPI_READ_WRITE)

#if defined(ENABLE_ALEXA_LED_NOTIFY)
#define key_alexa_led_op(cmd, arg0, arg1) \
    (int)key_op_entry((void *)(uint32)cmd, (void *)(uint32)arg0, (void *)(uint32)arg1, KEY_ALEXA_LED_OP)
#endif
