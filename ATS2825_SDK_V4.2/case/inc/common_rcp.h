...
extern void com_rcp_send_cmd_pkg(uint8 *data_ptr, uint16 length) __FAR__;
...
extern void com_rcp_set_ext_cb(rcp_ext_serv_func *app_rcp_cb, uint32 server_id) __FAR__;
extern void com_rcp_clr_ext_cb(uint32 server_id) __FAR__;
