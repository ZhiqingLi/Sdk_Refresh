...
typedef enum {
    ...
    //get linein pipe use size
    MSG_LINEIN_EG_GET_CAP_SIZE_SYNC,
...
#endif
    MSG_BTSTACK_AVRCP_GET_ELEMENT_ATTR_PTR_SYNC = 0x608,
    /****************************** BTSTACK HFP ******************************/
    ...
    MSG_BTSTACK_HFP_BTCALL_EXIT_SYNC = 0x70d,
...
#ifdef __BQB_TEST_PROFILE_
    MSG_BTSTACK_BQB_SPP_CLIENT_BACK_LINK = 0x82D,
    MSG_BTSTACK_BQB_SPP_CLIENT_DISCONNECT = 0x82E,
#endif

    //for smart recognize deal
    MSG_BTSTACK_SMART_SEND_START = 0x880,
    MSG_BTSTACK_SMART_SEND_END = 0x881,
    MSG_BTSTACK_SMART_DEV_INFO = 0x882,
    MSG_BTSTACK_SET_DATA_ENCRYPT_CALLBACK = 0x883,

    MSG_BTSTACK_DISCONNECT_ACL_SYNC = 0x89C,
    MSG_BTSTACK_GET_XIAOWEI_PID = 0x89D,
    MSG_BTSTACK_GET_MANUFACTUREER_ID = 0x89E,
    MSG_BTSTACK_GET_MAC_ADDR = 0x89F,
    ...
    MSG_BTSATCK_SPP_DISCONNECT = 0x9FE,
    MSG_BTSATCK_BLE_DISCONNECT = 0x9FF,


    /****************************** BTPLAY ENGINE ******************************/
    MSG_BTPLAYEG_BASE = 0xa00,
    MSG_PLAYEREG_RECOGNIZE_START = 0xa01,
    MSG_PLAYEREG_RECOGNIZE_STOP = 0xa02,
    MSG_PLAYEREG_RECOGNIZE_DOING = 0xa03,
    MSG_PLAYEREG_RECOGNIZE_PAUSE_MUSIC = 0xa04,
    MSG_PLAYEREG_RECOGNIZE_RESUME_MUSIC = 0xa05,
    MSG_LINEIN_STOP_REG = 0xa06,
