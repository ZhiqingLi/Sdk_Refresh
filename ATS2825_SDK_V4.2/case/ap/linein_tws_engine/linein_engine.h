...
extern uint32 g_first_no_sample;
...
extern int8 clear_smart_timer_id;
extern int8 count_free_dsp_timer_id;
...
extern void count_free_dsp_deal(void) __FAR__;
...
extern void clear_smart_response(void);

#define ADC_SAMPLE_BUFFER  (0x9fc18580)
#define ADC_SAMPLE_BUFFER_SIZE (0x1000) //ADC buff大小
#define ADC_SAMPLE_BUFFER_LEN (0x1000) //ADC buff真正使用的大小
...
#define ADC_TEMP_SIZE 0x200
#define LINEIN_ACUPY_SIZE (ADC_SAMPLE_BUFFER_SIZE + ADC_TEMP_SIZE)
