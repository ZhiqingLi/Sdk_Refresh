...
MUS_STATIC const key_event_map_t __section__(".rodata.ke_maplist") music_play_key_map_list[] = {
    ...
    /*! 短按按next切换下一曲 */
    { { KEY_NEXT_VOLADD, 0, KEY_TYPE_LONG | KEY_TYPE_HOLD, KEY_DEAL_FILTER_UP }, play_key_next },
    /*! 短按按prev切换上一曲 */
    { { KEY_PREV_VOLSUB, 0, KEY_TYPE_LONG | KEY_TYPE_HOLD, KEY_DEAL_FILTER_UP }, play_key_prev },
#else
    /*! 短按按next切换下一曲 */
