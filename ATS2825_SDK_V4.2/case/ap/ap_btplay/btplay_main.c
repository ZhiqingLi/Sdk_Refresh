...
//int8 g_smart_timer = -1;
//int8 g_smart_rec_buf_timer = -1;
//uint8 g_smart_record_flag;
//uint8 g_smart_status_cnt;
...
btplay_main_exit:
    ...
    g_app_info_state_all.voice_recongnize_mode = 0;
...
#if defined(SUPPORT_MIC_MUTE_FUNCTION)
    com_smart_mic_mute(0, FALSE);
#endif

#if defined(ENABLE_ALEXA_LED_NOTIFY)
    lp_update_alexa_state(ALEXA_STATE_TYPE_MODE_CHANGE, 0);
#endif
