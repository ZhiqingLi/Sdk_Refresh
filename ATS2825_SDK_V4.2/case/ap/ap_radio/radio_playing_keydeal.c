...
const key_event_map_t __section__(".rodata.ke_maplist") radio_play_ke_maplist[] = {
    ...
    /*! 切换到下一个频点 */
    { { KEY_NEXT_VOLADD, 0, KEY_TYPE_LONG | KEY_TYPE_HOLD, KEY_DEAL_FILTER }, radio_play_key_deal_next_freq },
#else
    /*! 切换到下一个频点 */
...
#if defined(BOARD_LINKPLAY_MUVO)
    /*! 切换到上一个频点 */
    { { KEY_PREV_VOLSUB, 0, KEY_TYPE_LONG | KEY_TYPE_HOLD, KEY_DEAL_NULL }, radio_play_key_deal_prev_freq },
#else
    /*! 切换到上一个频点 */
