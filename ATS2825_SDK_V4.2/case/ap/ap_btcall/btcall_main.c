...
#if defined(BOARD_LINKPLAY_DEMO) || defined(BOARD_LINKPLAY_MUVO) || defined(BOARD_DPI_7C370_FAR) || defined(BOARD_JL_36410_FAR) || defined(BOARD_LINKPLAY_FAR_DEMO)
    if(g_bt_stack_cur_info.phone_type == 1) {
        //IOS force disconnect ble,, fix voice not continuous error
        com_btmanager_unlink_spp_ble_profile(1);
        sys_os_time_dly(10);
        com_set_ble_discoverable(0);
    }

#if defined(BOARD_DPI_7C370_FAR) || defined(BOARD_JL_36410_FAR) || defined(BOARD_LINKPLAY_FAR_DEMO)
    lp_dsp_set_call_mode();
    lp_dsp_set_post_gain(0);
#endif
#endif
...
#if defined(BOARD_DPI_7C370_FAR) || defined(BOARD_JL_36410_FAR) || defined(BOARD_LINKPLAY_FAR_DEMO)
    lp_dsp_set_asr_mode();
    lp_dsp_set_post_gain(10);       //output volume set to 20db
#endif
#endif
