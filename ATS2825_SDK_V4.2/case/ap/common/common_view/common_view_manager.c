...
extern const lp_cb_func_t g_lp_func_cb;
#endif
...
#ifdef SMART_BOX_OPUS_MODE
    lp_init(&g_lp_func_cb);
    lp_set_data_encrypt_callback();
//    if(g_lp_func_cb.nFuncBitMap & ) {
//#if defined(BOARD_CAR_KS_FREEPLAY)
//        lp_dsp_set_mic_distance(35);    //set microphone distance to 35mm
//        lp_dsp_set_post_gain(5);        //set post gain to 10db
//#endif
//    }
