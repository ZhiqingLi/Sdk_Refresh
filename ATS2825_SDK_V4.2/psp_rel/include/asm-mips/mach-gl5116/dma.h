...
{
    act_writel_inline(act_readl_inline(dma_channel_reg(dmanr, DMA_CTL_OFF)) | (0x01 << DMA0CTL_DMA0START),
                      dma_channel_reg(dmanr, DMA_CTL_OFF));
}
...
static inline void reset_dma(int dmanr)
{
    act_writel_inline(act_readl_inline(DMA_CHANNEL_BASE + dmanr * DMA_CHANNEL_LEN + DMA_CTL_OFF) & (~0x01),
                      DMA_CHANNEL_BASE + dmanr * DMA_CHANNEL_LEN + DMA_CTL_OFF);
}

static inline void start_dma(int dmanr)
{
    act_writel_inline(act_readl_inline(DMA_CHANNEL_BASE + dmanr * DMA_CHANNEL_LEN + DMA_CTL_OFF) |
                      (0x01 << DMA0CTL_DMA0START), DMA_CHANNEL_BASE + dmanr * DMA_CHANNEL_LEN + DMA_CTL_OFF);
}
