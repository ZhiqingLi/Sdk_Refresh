 ...
 */
int32_t init_vb(VBContext *vb, int32_t num_channels, int32_t sample_rate, int32_t f_cut);
 ...
 * @return error code. VB_ERROR_OK means successful, other codes indicate error.
 */
int32_t apply_vb(VBContext *vb, int16_t *pcm_in, int16_t *pcm_out, int32_t n, int32_t intensity);
