...
//	PDS(按键开始)		SPR(短按松开)		  CPS(长按开始)		   CPH(长按保持)	  CPR(长按松开)
	{MSG_NONE,			MSG_WIFI_WPS, 		 MSG_WIFI_FACTORY,   	MSG_WIFI_FACTORY,	 MSG_NONE		   },	//SW1
	{MSG_NONE,			MSG_WIFI_NEXT_CH,	 MSG_NONE,            MSG_NONE,			     MSG_NONE		   },	//SW2
	{MSG_NONE,			MSG_MODE, 		     MSG_NONE, 			      MSG_NONE,			     MSG_NONE		   },	//SW3
	{MSG_NONE,			MSG_WIFI_TALK,		 MSG_NONE,	          MSG_NONE,			     MSG_NONE		   },	//SW4	
	{MSG_NONE,			MSG_PRE,			     MSG_FB_START,			  MSG_FB_START,			 MSG_FF_FB_END },	//SW5
	{MSG_NONE,			MSG_PLAY_PAUSE,		 MSG_WIFI_SAVE,		    MSG_NONE,			     MSG_NONE		   },	//SW6 
	
	{MSG_NONE,			MSG_NEXT,			     MSG_FF_START,			  MSG_FF_START,			 MSG_FF_FB_END },	//SW7
	{MSG_NONE,			MSG_WIFI_WPS, 		 MSG_WIFI_FACTORY,   	MSG_NONE, 			   MSG_NONE		   },	//SW8
	{MSG_NONE,			MSG_WIFI_PRESET1,  MSG_NONE, 			      MSG_NONE, 			   MSG_NONE		   },	//SW9
	{MSG_NONE,			MSG_WIFI_PRESET2,	 MSG_NONE,			      MSG_NONE,			     MSG_NONE		   },	//SW10
