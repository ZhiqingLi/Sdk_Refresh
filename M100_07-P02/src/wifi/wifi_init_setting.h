...
#define MCU_CAP_PRJ_PROJECT_NAME	"NR-M100"

//**MCU+SID+name&:ÉèÖÃÉè±¸Ä¬ÈÏSSIDÃû³Æ
#define MCU_SSID_NAME	"M100"

//**MCU+PTV+nnn:Ê¹ÓÃµÄMCU Ð­ÒéµÄ°æ±¾ºÅÉèÖÃ
#define MCU_PTV_NUM		"000"		//nnnÎª0~999µÄÊý×Ö£¬±íÊ¾Ê¹ÓÃµÄMCU Ð­ÒéµÄ°æ±¾ºÅ£¬Ä¬ÈÏ000£»´ËÏîÉè¶¨ºÍcapacity µÄÎ»¶¨ÒåÓÐÒÀÀµ¹ØÏµ?
...
#define MCU_ALI_PID_PRODUCTID	"EDIFIER_ENTERTAINMENT_ATALK_MA1"	//Èç¹ûÕâÊÇÒ»¸ö°¢ÀïÐ¡ÖÇµÄÏîÄ¿£¬Çë»Ø¸´´ËÏî£¬productidÀ´×Ô°¢ÀïÌá¹©µÄprodconf.jsonÎÄ¼þÀïÃæmodel×Ö¶Î£¬ÀýÈç£ºEDIFIER_ENTERTAINMENT_ATALK_MA1
...
#define MCU_CAP_001_BIT3	1	//ÊÇ·ñ½ûÖ¹½ûÖ¹ÓïÒôÌáÊ¾£¬Ä¬ÈÏ0²»½ûÖ¹
...
#define MCU_CAP_001_BIT20	0	//¾²ÒôÊÇ·ñÓÉMCU¿ØÖÆ£¬Ä¬ÈÏÓÐMCUµÄÎª1£¬·ñÔòÎª0
#define MCU_CAP_001_BIT21	0	//ÉùµÀÊÇ·ñ×Ô¶¯±£´æ£¬·ñÔòÎª0
#define MCU_CAP_001_BIT22	0	//±£Áô
#define MCU_CAP_001_BIT23	0	//WiFiÄ£¿éÊÇ·ñÓÐ½ÓUSBÂó¿Ë·ç£¬Ä¬ÈÏÎªÃ»ÓÐ½Ó0£¬·ñÔòÎª1£¬ÒªÊ¹ÄÜÕâÒ»Î»Éè¶¨£¬±ØÐëÒªÍ¬Ê±Éè¶¨MCU+PTV+nnn£ºnnn>=002 ²ÅÉúÐ§£»Ö»ÓÐA31/A28Ö§³ÖÕâ¸ö¹¦ÄÜ£»²¢ÇÒ¹Ì¼þÐèÒªÊÇ±ê×¼¹Ì¼þ¡£
...
#define MCU_CAP_002_BIT9	1	//ÊÇ·ñÖ§³Ö¿ì½ÝÁ¬½ÓÂ·ÓÉÆ÷(¼´Í¨¹ý»·¾³ÖÐÆäËûÉè±¸»ñÈ¡Â·ÓÉÆ÷Ãû×ÖºÍÃÜÂë£¬µ±ÓÃ»§ÓÐÁ½¸öÒôÏä£¬ÆäÖÐÒ»¸öÒôÏäÒÑ¾­Á¬½ÓÂ·ÓÉÆ÷£¬ÁíÒ»¸öÒôÏä¿ÉÒÔ²»ÐèÒªapp¾ÍÄÜÁ¬½ÓÂ·ÓÉÆ÷ÁË¡£)£¬Ä¬ÈÏÎª0²»Ö§³Ö
#define MCU_CAP_002_BIT10	0	//ÊÇ·ñÖ§³Ö×Ô¶¯ÃÜÂë£¨µ±Á¬ÉÏÂ·ÓÉÆ÷Ê±£¬Éè±¸µÄÃÜÂëÊÇÂ·ÓÉÆ÷µÄÃÜÂë£¬Ö±µ½ÓÃ»§ÊÖ¶¯ÉèÖÃ¹Ì¶¨ÃÜÂë£©£¬Ä¬ÈÏÎª0²»Ö§³Ö
#define MCU_CAP_002_BIT11	0	//Á¬½ÓÂ·ÓÉÆ÷ºó£¬ÊÇ·ñ×Ô¶¯Òþ²ØAP£¬Ä¬ÈÏÎª0£¬²»Òþ²Ø
...
#endif
#define MCU_CAP_002_BIT22	1	//ÓÐÎÞ¶¨Ê±Í£Ö¹²¥·Å¹¦ÄÜ£¬Ä¬ÈÏÎª0£¬Ã»ÓÐ
#define MCU_CAP_002_BIT23	1	//ÓÐÎÞÍâ²¿¶¨Ê±¹Ø»ú¹¦ÄÜ£¬Ä¬ÈÏÎª0 £¨Èç¹ûÖ§³Ö£¬WiFi»áÔÚ¶¨Ê±µã·¢ËÍAXX+POW+OFF¸øMCU£¬MCU¿É»Ø¸´MCU+POW+OFF¸øWiFiÈ·ÈÏ£¬Èç¹ûWiFiÈÔÈ»»Ø¸´AXX+POW+OFF»òÕß2ÃëÄÚÎÞ»Ø¸´£¬¼´¿É¹Ø»ú£»Èç¹ûWiFi»Ø¸´AXX+BURNING£¬²»¿É¹Ø»ú£©
...
#define MCU_CAP_002_BIT29	0	//ÊÇ·ñ½ûÖ¹WIFIÄ£Ê½×Ô¶¯²¥·Å¹¦ÄÜ£¬Ä¬ÈÏÎª0¿ªÆôWIFIÄ£Ê½×Ô¶¯²¥·Å£¨×Ô¶¯²¥·ÅÉÏ´Î²¥·ÅµÄ¸èµ¥£©
...
#define MCU_CAP_STM_BIT23	0	//±£Áô
#define MCU_CAP_STM_BIT24	0	//±£Áô
#define MCU_CAP_STM_BIT25	0	//±£Áô
#define MCU_CAP_STM_BIT26	0	//±£Áô
...
#define MCU_CAP_PLM_BIT1	0	//ÓÐÎÞAux-In£¬Ä¬ÈÏ0£¨Èç¹ûApp²»ÐèÒªÏÔÊ¾µ±Ç°´¦ÓÚAux-In×´Ì¬£¬ÀýÈçÇÐ»»µ½Aux×´Ì¬WiFiÒÑ¾­¹Ø±Õ£¬Ôò´Ë´¦²»ÐèÒª»Ø¸´1£©
...
#define MCU_CAP_PLM_BIT7	0	//±£Áô
#define MCU_CAP_PLM_BIT8	0	//±£Áô
