...
#define FUNC_LINKY_HELLO_EN
#define FUNC_HBL_DNK_EN
...
//****************************************************************************************
#ifdef FUNC_LINKY_HELLO_EN
#define WIFI_POWER_PORT_OUT				GPIO_C_OUT
#define WIFI_POWER_PORT_BIT				GPIOC12
#endif
...
//****************************************************************************************
#ifdef FUNC_LINKY_HELLO_EN
#define WIFI_RESET_PORT_OUT				GPIO_A_OUT
#define WIFI_RESET_PORT_BIT				GPIOA12
#endif
...
//                 			WiFi MIC通道控制GPIO 配置       
//****************************************************************************************
#ifdef FUNC_HBL_DNK_EN
#define WIFI_MIC_PORT_OUT				GPIO_A_OUT
//#define WIFI_MIC_PORT_BIT				GPIOC10
#endif
...
//****************************************************************************************
	...
	#define SOUND_REMIND_VOL	    18	//设置提示音音量
	#define WIFI_SOUND_REMIND_VOL 18  //WiFi提示音音量
...
//****************************************************************************************
	#define FUNC_LINEIN_EN   					// Linein
		...
		#define LINEIN_DETECT_BIT_MASK		GPIOB30 
	#endif
...
#define AMP_POWER_PORT_BIT				  GPIOA24
...
//****************************************************************************************
	#define FUNC_BT_EN											//蓝牙功能
		...
		#define NOISE_SUPPRESSION_LEVEL			(4)			// 噪声抑制等级。取值范围(1 ~ 5)，0为关闭此功能
		#endif
...
//	#define	OPTION_CHARGER_DETECT		      //打开该宏定义，支持GPIO检测充电设备插入功能
	  ...
	  #define FUNC_GPIO_SOFT_POWERKEY_EN    //软开关用普通GPIO检测，该功能需要用硬开机和普通GPIO配合实现
		#define FUNC_GPIO_POWER_ON_EN         //GPIO控制系统上电
		#ifdef  FUNC_GPIO_SOFT_POWERKEY_EN
		  #define FUNC_GPIO_POWER_KEY_EN      //GPIO软开关复用功能选择
			#define POWERKEY_DETECT_PORT_PU			GPIO_C_PU
			#define POWERKEY_DETECT_PORT_PD			GPIO_C_PD
			#define POWERKEY_DETECT_PORT_IN			GPIO_C_IN
		  #define POWERKEY_DETECT_PORT_IE			GPIO_C_IE
			#define POWERKEY_DETECT_PORT_OE			GPIO_C_OE
			#define POWERKEY_DETECT_PORT_DS			GPIO_C_DS
			#define POWERKEY_DETECT_BIT				  GPIOC1
		#endif
		
		#ifdef FUNC_GPIO_POWER_ON_EN          //GPIO控制系统上电
			#define POWERON_GPIO_PORT_PU			GPIO_B_PU
			#define POWERON_GPIO_PORT_PD			GPIO_B_PD
			#define POWERON_GPIO_PORT_OUT			GPIO_B_OUT
		  #define POWERON_GPIO_PORT_IE			GPIO_B_IE
			#define POWERON_GPIO_PORT_OE			GPIO_B_OE
			#define POWERON_GPIO_PORT_BIT			GPIOB2
		#endif
	#endif
...
//		#define	ADC_KEY_PORT_CH2	ADC_CHANNEL_B5			//如果只使用2路ADC按键，则保留本行
  ...
  #define ADC_POWER_MONITOR_EN               //打开该宏定义，则电源检测在ADC检测电池电压
		  ...
		  #define ADC_POWER_MONITOR_PORT    ADC_CHANNEL_B7 
		#endif 
...
//	#define FUNC_IR_KEY_EN   							//IR KEY宏开关
	...
	#define FUNC_CODING_KEY_EN							//CODING KEY宏开关			
		#define 	CODING_KEY_A_PORT_IN	GPIO_C_IN
		#define		CODING_KEY_A_PORT_OE	GPIO_C_OE
		#define		CODING_KEY_A_PORT_PU	GPIO_C_PU
		#define		CODING_KEY_A_PORT_PD	GPIO_C_PD
		#define		CODING_KEY_A_PORT_INT	GPIO_C_INT	
		#define   CODING_KEY_A_PORT_DS	GPIO_C_DS
		#define		CODING_KEY_A_BIT		(1 << 2)	//GPIO_C[1] for signal A
	
		#define 	CODING_KEY_B_PORT_IE  GPIO_C_IE
		#define		CODING_KEY_B_PORT_IN	GPIO_C_IN		
		#define		CODING_KEY_B_PORT_OE	GPIO_C_OE
		#define		CODING_KEY_B_PORT_PU	GPIO_C_PU
		#define		CODING_KEY_B_PORT_PD	GPIO_C_PD
		#define   CODING_KEY_B_PORT_DS	GPIO_C_DS
		#define		CODING_KEY_B_BIT		(1 << 11)	//GPIO_C[2] for signal B
	
	  #define FUNC_POWER_KEY_EN							//软开关复用功能,需要同时开启宏USE_POWERKEY_SOFT_PUSH_BUTTON 该功能才真正有效
...
//                 ST数字功放应用功能配置        
//****************************************************************************************
#define FUNC_ST_DDX33X_EN
#ifdef FUNC_ST_DDX33X_EN
    #define STA369_POWER_OUT 			GPIO_A_OUT
	#define	STA369_POWER_IE				GPIO_A_IE
	#define	STA369_POWER_OE				GPIO_A_OE
	#define	STA369_POWER_PU				GPIO_A_PU
	#define	STA369_POWER_PD				GPIO_A_PD
	#define STA369_POWER_BIT   		    GPIOA22 
	
	#define STA369_POWER_ON()    do{GpioSetRegBits(STA369_POWER_PU, 	STA369_POWER_BIT);\
									GpioClrRegBits(STA369_POWER_PD, 	STA369_POWER_BIT);\
									GpioClrRegBits(STA369_POWER_IE, 	STA369_POWER_BIT);\
									GpioSetRegBits(STA369_POWER_OE, 	STA369_POWER_BIT);\
									GpioSetRegBits(STA369_POWER_OUT, 	STA369_POWER_BIT);\
									}while(0)
									
	#define STA369_POWER_OFF()   do{GpioSetRegBits(STA369_POWER_PU, 	STA369_POWER_BIT);\
									GpioClrRegBits(STA369_POWER_PD, 	STA369_POWER_BIT);\
									GpioClrRegBits(STA369_POWER_IE, 	STA369_POWER_BIT);\
									GpioSetRegBits(STA369_POWER_OE, 	STA369_POWER_BIT);\
									GpioClrRegBits(STA369_POWER_OUT, 	STA369_POWER_BIT);\
									}while(0)

	//GPIOB6	STA369_REST
	#define STA369_REST_OUT 			GPIO_A_OUT
	#define	STA369_REST_IE				GPIO_A_IE
	#define	STA369_REST_OE				GPIO_A_OE
	#define	STA369_REST_PU				GPIO_A_PU
	#define	STA369_REST_PD				GPIO_A_PD
	#define STA369_REST_BIT   		    GPIOA23	
	
	#define STA369_REST_HIGH()   do{GpioSetRegBits(STA369_REST_PU, 	STA369_REST_BIT);\
									GpioClrRegBits(STA369_REST_PD, 		STA369_REST_BIT);\
									GpioClrRegBits(STA369_REST_IE, 		STA369_REST_BIT);\
									GpioSetRegBits(STA369_REST_OE, 		STA369_REST_BIT);\
									GpioSetRegBits(STA369_REST_OUT, 	STA369_REST_BIT);\
									}while(0)
									
	#define STA369_REST_LOW()  	 do{GpioSetRegBits(STA369_REST_PU, 	STA369_REST_BIT);\
									GpioClrRegBits(STA369_REST_PD, 		STA369_REST_BIT);\
									GpioClrRegBits(STA369_REST_IE, 		STA369_REST_BIT);\
									GpioSetRegBits(STA369_REST_OE, 		STA369_REST_BIT);\
									GpioClrRegBits(STA369_REST_OUT, 	STA369_REST_BIT);\
									}while(0)
#endif
...
#if 1 //def FUNC_SINGLE_LED_EN
 #define LED_RED_MODE_PORT_OUT		GPIO_A_OUT
// #define LED_RED_MODE_BIT_MASK		GPIOA24

 #define LED_RED_MODE_PORT_IE		(LED_RED_MODE_PORT_OUT + 1)
 #define LED_RED_MODE_PORT_OE		(LED_RED_MODE_PORT_OUT + 2)	
 #define LED_RED_MODE_PORT_PU		(LED_RED_MODE_PORT_OUT + 5)	
 #define LED_RED_MODE_PORT_PD		(LED_RED_MODE_PORT_OUT + 6)	
 #define LED_RED_MODE_PORT_1P7MA		(LED_RED_MODE_PORT_OUT + 7)	
 #define LED_RED_MODE_PORT_2P4MA		(LED_RED_MODE_PORT_OUT + 8)
 
 #ifdef LED_RED_MODE_BIT_MASK
  #define LED_RED_MODE_ON()				do{\
										GpioSetRegOneBit(LED_RED_MODE_PORT_PU, LED_RED_MODE_BIT_MASK);\
										...
										GpioSetRegOneBit(LED_RED_MODE_PORT_OUT, LED_RED_MODE_BIT_MASK);\
									}while(0)
	...
	#define LED_RED_MODE_OFF()				do{\
										...
										GpioClrRegOneBit(LED_RED_MODE_PORT_IE, LED_RED_MODE_BIT_MASK);\
										GpioSetRegOneBit(LED_RED_MODE_PORT_OE, LED_RED_MODE_BIT_MASK);\
										GpioClrRegOneBit(LED_RED_MODE_PORT_OUT, LED_RED_MODE_BIT_MASK);\
									}while(0)
 #else
...
//WIFI模式灯	
 #define LED_GREEN_MODE_PORT_OUT			GPIO_B_OUT
 #define LED_GREEN_MODE_BIT_MASK			GPIOB21
 #define LED_GREEN_MODE_PORT_IE			(LED_GREEN_MODE_PORT_OUT + 1)
 #define LED_GREEN_MODE_PORT_OE			(LED_GREEN_MODE_PORT_OUT + 2)	
 #define LED_GREEN_MODE_PORT_PU			(LED_GREEN_MODE_PORT_OUT + 5)	
 #define LED_GREEN_MODE_PORT_PD			(LED_GREEN_MODE_PORT_OUT + 6)	
 #define LED_GREEN_MODE_PORT_1P7MA		(LED_GREEN_MODE_PORT_OUT + 7)	
 #define LED_GREEN_MODE_PORT_2P4MA		(LED_GREEN_MODE_PORT_OUT + 8)
	...
	#define LED_GREEN_MODE_ON()				do{\
										...
										GpioClrRegOneBit(LED_GREEN_MODE_PORT_OUT, LED_GREEN_MODE_BIT_MASK);\
									}while(0)
	...
	#define LED_GREEN_MODE_OFF()				do{\
										...
										GpioClrRegOneBit(LED_GREEN_MODE_PORT_IE, LED_GREEN_MODE_BIT_MASK);\
										GpioSetRegOneBit(LED_GREEN_MODE_PORT_OE, LED_GREEN_MODE_BIT_MASK);\
										GpioSetRegOneBit(LED_GREEN_MODE_PORT_OUT, LED_GREEN_MODE_BIT_MASK);\
									}while(0)
 #else
...
//WIFI模式灯	
 #define LED_BLUE_MODE_PORT_OUT			GPIO_B_OUT
 #define LED_BLUE_MODE_BIT_MASK			GPIOB20
 #define LED_BLUE_MODE_PORT_IE			(LED_BLUE_MODE_PORT_OUT + 1)
 #define LED_BLUE_MODE_PORT_OE			(LED_BLUE_MODE_PORT_OUT + 2)	
 #define LED_BLUE_MODE_PORT_PU			(LED_BLUE_MODE_PORT_OUT + 5)	
 #define LED_BLUE_MODE_PORT_PD			(LED_BLUE_MODE_PORT_OUT + 6)	
 #define LED_BLUE_MODE_PORT_1P7MA		(LED_BLUE_MODE_PORT_OUT + 7)	
 #define LED_BLUE_MODE_PORT_2P4MA		(LED_BLUE_MODE_PORT_OUT + 8)
	...
	#define LED_BLUE_MODE_ON()				do{\
										...
										GpioClrRegOneBit(LED_BLUE_MODE_PORT_OUT, LED_BLUE_MODE_BIT_MASK);\
									}while(0)
	...
	#define LED_BLUE_MODE_OFF()				do{\
										...
										GpioClrRegOneBit(LED_BLUE_MODE_PORT_IE, LED_BLUE_MODE_BIT_MASK);\
										GpioSetRegOneBit(LED_BLUE_MODE_PORT_OE, LED_BLUE_MODE_BIT_MASK);\
										GpioSetRegOneBit(LED_BLUE_MODE_PORT_OUT, LED_BLUE_MODE_BIT_MASK);\
									}while(0)
 #else
...
#ifdef  FUNC_WIFI_EN
    MODULE_ID_WIFI,
		MODULE_ID_PLAYER_WIFI_USB,
		MODULE_ID_PLAYER_WIFI_SD,
#endif
#ifdef FUNC_SLAVE_BLUETOOTH_EN
