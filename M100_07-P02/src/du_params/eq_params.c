...
{
	{ 0x0001, 0x0032, 0x02cd, 0x043c }, // Parameters for filter 0
	{ 0x0000, 0x0051, 0x02cd, 0x03ac }, // Parameters for filter 1
	{ 0x0000, 0x021e, 0x0266, 0x041c }, // Parameters for filter 2
	{ 0x0000, 0x0826, 0x0200, 0x046f }, // Parameters for filter 3
	{ 0x0002, 0x350b, 0x0271, 0x0479 }, // Parameters for filter 4
};
