...
#define PARAM_FMRX_CHCUR            0x26
#define PARAM_FMRX_CHCNT            0x27
#define PARAM_FMRX_CHBUF            0x28        //26Byte
#define PARAM_FMTX_FREQ             0x42        //FM TX freq 2 Byte
#define PARAM_ECHO_LEVEL            0x44        //echo level 1 Byte
#define PARAM_ECHO_DELAY            0x45        //echo delay 1 Byte
