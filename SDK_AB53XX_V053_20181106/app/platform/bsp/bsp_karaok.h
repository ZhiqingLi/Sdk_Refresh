...
void karaok_mic_first_music_vol_fade_enable(u16 fade_in_step, u16 fade_out_step); //MIC优先时, 音乐淡入淡出使能, 并设置淡入淡出步进.
void karaok_mic_first_music_vol_fade_disable(void);  //MIC优先时, 关闭音乐淡入淡出.
#endif
