...
#if BT_BACKSTAGE_EN
#undef FUNC_BTHID_EN
#define FUNC_BTHID_EN               0   //后台暂不支持独立HID模式
#endif
...
#if BT_BACKSTAGE_EN                 //蓝牙后台, 不能打开独立自拍器模式.
#undef FUNC_BTHID_EN
#define FUNC_BTHID_EN               0
#endif
 ...
 *****************************************************************************/
#if ((UART0_PRINTF_SEL == PRINTF_PB2) && (SD0_MAPPING == SD0MAP_G2))
    #undef  MUSIC_SDCARD_EN
    #define MUSIC_SDCARD_EN         0
#elif ((UART0_PRINTF_SEL == PRINTF_PA7) && (SD0_MAPPING == SD0MAP_G1))
    #undef  MUSIC_SDCARD_EN
    #define MUSIC_SDCARD_EN         0
...
#error "VBAT_DETECT_MUX_SDCLK and USER_ADKEY_MUX_SDCLK can't open at sametime"
#endif
#endif
