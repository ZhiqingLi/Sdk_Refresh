...
#define RES_BUF_SPDIF_MODE_MP3      *mul_lang_tbl[sys_cb.lang_id][IDX_SPDIF_MODE_MP3 ].ptr
#define RES_LEN_SPDIF_MODE_MP3      *mul_lang_tbl[sys_cb.lang_id][IDX_SPDIF_MODE_MP3 ].len
...
#define RES_BUF_SPDIF_MODE_MP3          RES_BUF_ZH_SPDIF_MODE_MP3
#define RES_LEN_SPDIF_MODE_MP3          RES_LEN_ZH_SPDIF_MODE_MP3
...
#define RES_BUF_SPDIF_MODE_MP3          RES_BUF_EN_SPDIF_MODE_MP3
#define RES_LEN_SPDIF_MODE_MP3          RES_LEN_EN_SPDIF_MODE_MP3
...
#define RES_BUF_MAGIC_CHG_MP3           RES_BUF_EN_MAGIC_CHG_MP3
#define RES_LEN_MAGIC_CHG_MP3           RES_LEN_EN_MAGIC_CHG_MP3
#define RES_BUF_MAGIC_DIS_MP3           RES_BUF_EN_MAGIC_DIS_MP3
#define RES_LEN_MAGIC_DIS_MP3           RES_LEN_EN_MAGIC_DIS_MP3

#define RES_BUF_REC_START_MP3           RES_BUF_EN_REC_START_MP3
#define RES_LEN_REC_START_MP3           RES_LEN_EN_REC_START_MP3
#define RES_BUF_REC_END_MP3             RES_BUF_EN_REC_END_MP3
#define RES_LEN_REC_END_MP3             RES_LEN_EN_REC_END_MP3
