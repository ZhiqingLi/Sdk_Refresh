...
{
	{ 0x0000, 0x0352, 0x0314, 0x0556 }, // Parameters for filter 0
	{ 0x0000, 0x07d0, 0x0733, 0x035e }, // Parameters for filter 1
	{ 0x0000, 0x1194, 0x0366, 0x05a6 }, // Parameters for filter 2
	{ 0x0000, 0x2710, 0x0333, 0x041e }, // Parameters for filter 3
	{ 0x0002, 0x34bc, 0x02cd, 0x0556 }, // Parameters for filter 4
};
