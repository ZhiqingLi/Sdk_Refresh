...
{
	{ 0x0004, 0x0039, 0x039a, 0x0382 }, // Parameters for filter 0
	{ 0x0000, 0x007d, 0x0366, 0x042d }, // Parameters for filter 1
	{ 0x0000, 0x03db, 0x0600, 0x0424 }, // Parameters for filter 2
	{ 0x0000, 0x13d3, 0x04cd, 0x0418 }, // Parameters for filter 3
	{ 0x0002, 0x39d0, 0x0366, 0x042d }, // Parameters for filter 4
};
