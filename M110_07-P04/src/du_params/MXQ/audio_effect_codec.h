...
#define AUDIO_EFFECT_PARAM_VB_INTENSITY        (    8)  //unit in percent
...
#define AUDIO_EFFECT_PARAM_DRC_PREGAIN1        (12953)  //10.00dB
...
#define AUDIO_EFFECT_PARAM_DRC_THRESHHOLD3     (-1000)  // 10.00dB
