...
{
	{ 0x0004, 0x0050, 0x0600, 0x041e }, // Parameters for filter 0
	{ 0x0000, 0x0352, 0x0666, 0x045c }, // Parameters for filter 1
	{ 0x0000, 0x0708, 0x0733, 0x0391 }, // Parameters for filter 2
	{ 0x0000, 0x0dac, 0x0466, 0x04e5 }, // Parameters for filter 3
	{ 0x0000, 0x2710, 0x04cd, 0x045c }, // Parameters for filter 4
};
