...
const uint16_t gDecVolArr[MAX_VOLUME + 1] =
{
	...
	780,	895,	930,	1070,	1220,	1360,	1500,	1600//最高音量约420mVrms
};
#endif
...
const uint16_t gAnaVolArr[MAX_VOLUME + 1] =
{
	...
	91,		107,	125,	147,	173,	204,	240,	282,
	332,	391,	460,	541,	636,	748,	880,	1035,
	1218,	1433,	1786,	2284,	2834,	3446, 3900,	4150//最高音量约800mVrms
};
...
void CommonMsgProccess(uint16_t Msg)
{
	...
	if(gWiFi.InitState)
	{
		if(Msg == MSG_WIFI_MIC)
		{
		#ifndef FUNC_WIFI_ALEXA_PROJECT_EN
