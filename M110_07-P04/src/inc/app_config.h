...
#if 0//def FUNC_M110_M120_WIFI_EN
...
#define WIFI_POWER_PORT_BIT				GPIOA22
#endif
...
#define WIFI_MIC_PORT_BIT				GPIOA20
#endif
...
//****************************************************************************************
	#define FUNC_LINEIN_EN   					// Linein
		...
		#define LINEIN_DETECT_BIT_MASK		GPIOA10
	#endif
...
//	#define USE_POWERKEY_SOFT_PUSH_BUTTON //for soft push button case ONLY
	...
	#define	OPTION_CHARGER_DETECT		      //打开该宏定义，支持GPIO检测充电设备插入功能
			...
			#define CHARGE_DETECT_BIT				  GPIOA0
	#endif
...
//	  #define FUNC_GPIO_SLIDE_SWITCH_EN     //硬开关用普通GPIO检测，该功能主要应用在WiFi项目中
		#define FUNC_GPIO_POWER_ON_EN         //GPIO控制系统上电
			...
			#define POWERKEY_DETECT_PORT_DS			GPIO_A_DS
			#define POWERKEY_DETECT_BIT				  GPIOA23
		#endif
...
//                 定时关机功能配置        
//****************************************************************************************
#ifndef FUNC_MXQ_MXQ_HF30_EN
#define FUNC_SLEEP_EN
#endif /* FUNC_MXQ_HM30_EN */
