...
#define RES_BUF_CALLOUT_MP3         *mul_lang_tbl[sys_cb.lang_id][IDX_CALLOUT_MP3    ].ptr
#define RES_LEN_CALLOUT_MP3         *mul_lang_tbl[sys_cb.lang_id][IDX_CALLOUT_MP3    ].len
#define RES_BUF_PRIV_CALL_MP3       *mul_lang_tbl[sys_cb.lang_id][IDX_PRIV_CALL_MP3  ].ptr
#define RES_LEN_PRIV_CALL_MP3       *mul_lang_tbl[sys_cb.lang_id][IDX_PRIV_CALL_MP3  ].len
#define RES_BUF_TAKE_PHOTO_MP3      *mul_lang_tbl[sys_cb.lang_id][IDX_TAKE_PHOTO_MP3 ].ptr
#define RES_LEN_TAKE_PHOTO_MP3      *mul_lang_tbl[sys_cb.lang_id][IDX_TAKE_PHOTO_MP3 ].len
