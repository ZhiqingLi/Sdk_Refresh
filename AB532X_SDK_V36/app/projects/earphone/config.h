...
#define FMRX_INSIDE_EN                  0   //是否使用内置收音
#define FMRX_QN8035_EN                  0

///外接收音芯片相关配置
#define FMRX_2_SDADC_EN                 0                               //外接收音是否进SDADC，否则直通DAC。进SDADC可以调EQ，FMRX录音等功能。
...
#define LINEIN_IS_ONLINE()
#define IS_DET_LINEIN_BUSY()
...
///通过配置工具选择检测GPIO
#define MIC_DETECT_INIT()
#define MIC_IS_ONLINE()
#define IS_DET_MIC_BUSY()
...
#define SD_IS_ONLINE()
#define IS_DET_SD_BUSY()

#define SD1_DETECT_INIT()
#define SD1_IS_ONLINE()
#define IS_DET_SD1_BUSY()
...
#define CHARGE_FINISH_INTO_LOWPOWER     1           //充电完成进入低功耗.
#define CHARGE_OUT_POWER_ON             1           //充电时, 拔出充电则开机(DC不断电才支持)
