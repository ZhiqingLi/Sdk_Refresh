...
#ifdef USB_AUDIO_DYN_CFG_16BIT
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x0D)
#elif defined(USB_AUDIO_DYN_CFG_24BIT)
#ifdef USB_AUDIO_32BIT
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x1E)
#else
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x0E)
#endif
#else // !USB_AUDIO_DYN_CFG_16BIT && !USB_AUDIO_DYN_CFG_24BIT
#ifdef USB_AUDIO_32BIT
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x1F)
#else
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x0F)
#endif
#endif // !USB_AUDIO_DYN_CFG_16BIT && !USB_AUDIO_DYN_CFG_24BIT
#else // !USB_AUDIO_DYN_CFG
#ifdef USB_AUDIO_192K
#ifdef USB_AUDIO_24BIT
#ifdef USB_HIGH_SPEED
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x08)
#else
#error "Unsupported 192K/24BIT USB audio configuration"
#endif
#elif defined(USB_AUDIO_32BIT)
#ifdef USB_HIGH_SPEED
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x18)
#else
#error "Unsupported 192K/32BIT USB audio configuration"
#endif
#else
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x07)
#endif
#elif defined(USB_AUDIO_96K)
#ifdef USB_AUDIO_24BIT
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x04)
#elif defined(USB_AUDIO_32BIT)
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x14)
#else
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x03)
#endif
#elif defined(USB_AUDIO_44_1K)
#ifdef USB_AUDIO_24BIT
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x06)
#elif defined(USB_AUDIO_32BIT)
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x16)
#else
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x02)
#endif
#else // 48K
#ifdef USB_AUDIO_24BIT
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x05)
#elif defined(USB_AUDIO_32BIT)
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x15)
#else
#define USB_AUDIO_PRODUCT_ID                    (USB_AUDIO_PRODUCT_ID_BASE + 0x01)
#endif
#endif
