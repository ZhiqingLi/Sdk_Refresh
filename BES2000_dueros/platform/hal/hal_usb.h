...
#define USB_MAX_PACKET_SIZE_ISO_DRV             800
// 192K sample rate, 24 bits, 2 channels = 1152 bytes/ms (2 pkts/ms, 576 bytes/pkt)
// NOTE: (576 * 2) RX-FIFO cannot receive 192Kx24BIT stream stably.
#else
...
#define USB_MAX_PACKET_SIZE_ISO_DRV             768
#endif
