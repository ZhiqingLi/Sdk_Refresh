...
// reg_10
#define CODEC_CODEC_RX_OVERFLOW_IMASK(n)         (((n) & 0x1F) << 0)
#define CODEC_CODEC_RX_OVERFLOW_IMASK_MASK       (0x1F << 0)
#define CODEC_CODEC_RX_OVERFLOW_IMASK_SHIFT      (0)
#define CODEC_CODEC_RX_UNDERFLOW_IMASK(n)        (((n) & 0x1F) << 5)
#define CODEC_CODEC_RX_UNDERFLOW_IMASK_MASK      (0x1F << 5)
#define CODEC_CODEC_RX_UNDERFLOW_IMASK_SHIFT     (5)
#define CODEC_CODEC_TX_OVERFLOW_MASK             (1 << 10)
#define CODEC_CODEC_TX_UNDERFLOW_MASK            (1 << 11)
#define CODEC_DSD_RX_OVERFLOW_MASK               (1 << 12)
#define CODEC_DSD_RX_UNDERFLOW_MASK              (1 << 13)
#define CODEC_DSD_TX_OVERFLOW_MASK               (1 << 14)
#define CODEC_DSD_TX_UNDERFLOW_MASK              (1 << 15)
#define CODEC_MC_OVERFLOW_MASK                   (1 << 16)
#define CODEC_MC_UNDERFLOW_MASK                  (1 << 17)
#define CODEC_IIR_RX_OVERFLOW_MASK               (1 << 18)
#define CODEC_IIR_RX_UNDERFLOW_MASK              (1 << 19)
#define CODEC_IIR_TX_OVERFLOW_MASK               (1 << 20)
#define CODEC_IIR_TX_UNDERFLOW_MASK              (1 << 21)
#define CODEC_EVENT_TRIGGER_MASK                 (1 << 22)
#define CODEC_FB_CHECK_ERROR_TRIG_CH0_MASK       (1 << 23)
#define CODEC_FB_CHECK_ERROR_TRIG_CH1_MASK       (1 << 24)
#define CODEC_VAD_FIND_MASK                      (1 << 25)
#define CODEC_VAD_NOT_FIND_MASK                  (1 << 26)
#define CODEC_BT_TRIGGER_MASK                    (1 << 27)
#define CODEC_ADC_MAX_OVERFLOW_MASK              (1 << 28)
