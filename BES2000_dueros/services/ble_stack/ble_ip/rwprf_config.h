...
#define CFG_SMART_VOICE
#elif defined (__AMA_VOICE__)
#define CTG_AMA_VOICE
#elif defined(__DMA_VOICE__)
#define CTG_DMA_VOICE
#else
//#define CFG_PRF_DATAPATH_SERVER 
#endif
...
#if defined(CFG_SMART_VOICE)
#define BLE_SMARTVOICE			1
#else
#define BLE_SMARTVOICE			0
#endif	// defined(CFG_SMART_VOICE)

#if defined(CTG_AMA_VOICE)
#define BLE_AMA_VOICE			1
#else
#define BLE_AMA_VOICE			0
#endif

#if defined(CTG_DMA_VOICE)
...
/// BLE_CLIENT_PRF indicates if at least one client profile is present
        ...
        || BLE_UDS_CLIENT || BLE_BCS_CLIENT || BLE_DATAPATH_SERVER || BLE_SMARTVOICE ||BLE_AMA_VOICE || BLE_DMA_VOICE || BLE_OTA)
