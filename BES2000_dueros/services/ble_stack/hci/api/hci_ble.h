...
void hci_acl_rx_data_received(uint16_t hdl_flags, uint16_t datalen, HciBuffer *hciBuffer);
...
uint8_t hci_evt_received(uint8_t code, uint8_t length, HciBuffer *hciBuffer);
