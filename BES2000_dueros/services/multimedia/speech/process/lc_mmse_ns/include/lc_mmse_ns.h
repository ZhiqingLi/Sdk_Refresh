...
void lc_mmse_ns_set_ec2_state(LC_MMSE_NS_State *state, void *ec2_state);

void lc_mmse_ns_set_echo_suppress(LC_MMSE_NS_State *st, int echo_suppress);

void lc_mmse_ns_analysis(LC_MMSE_NS_State *state, const short *in);

int lc_mmse_ns_run(LC_MMSE_NS_State *st, short *in);

int lc_mmse_ns_deinit(LC_MMSE_NS_State *st);
