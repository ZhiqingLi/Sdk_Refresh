...
static const int16_t COEF_DEF(filter_44p1k_to_48k_16coef)[] = {
    #include "resample_44p1k_to_48k_filter_16coef.txt"
};
const struct RESAMPLE_COEF_T COEF_DEF(resample_coef_44p1k_to_48k_16coef) = {
    .upsample_factor = 160,
    .downsample_factor = 147,
    .phase_coef_num = 16,
    .total_coef_num = ARRAY_SIZE(filter_44p1k_to_48k_16coef),
    .coef_group = filter_44p1k_to_48k_16coef,
};

static const int16_t COEF_DEF(filter_44p1k_to_48k_28coef)[] = {
    #include "resample_44p1k_to_48k_filter_28coef.txt"
};
const struct RESAMPLE_COEF_T COEF_DEF(resample_coef_44p1k_to_48k_28coef) = {
    .upsample_factor = 160,
    .downsample_factor = 147,
    .phase_coef_num = 28,
    .total_coef_num = ARRAY_SIZE(filter_44p1k_to_48k_28coef),
    .coef_group = filter_44p1k_to_48k_28coef,
};

static const int16_t COEF_DEF(filter_44p1k_to_48k_24coef)[] = {
    #include "resample_44p1k_to_48k_filter_24coef.txt"
};
const struct RESAMPLE_COEF_T COEF_DEF(resample_coef_44p1k_to_48k_24coef) = {
    .upsample_factor = 160,
    .downsample_factor = 147,
    .phase_coef_num = 24,
    .total_coef_num = ARRAY_SIZE(filter_44p1k_to_48k_24coef),
    .coef_group = filter_44p1k_to_48k_24coef,
};
