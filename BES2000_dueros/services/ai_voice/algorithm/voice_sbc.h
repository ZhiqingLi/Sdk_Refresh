...
#define VOICE_SBC_CHANNEL_MODE 			(SBC_CHNL_MODE_MONO)
...
#define VOICE_SBC_SAMPLE_RATE			(SBC_CHNL_SAMPLE_FREQ_16)
...
#define VOICE_SBC_FRAME_PERIOD_IN_MS	(24)
...
#define VOICE_SBC_ENCODED_DATA_SIZE_PER_FRAME	(VOICE_SBC_BLOCK_SIZE*6)
...
#define VOICE_SBC_CAPTURE_INTERVAL_IN_MS	(24)
