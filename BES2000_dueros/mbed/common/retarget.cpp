...
#ifdef __GNUC__
// Already defined in common.mk
//#define TOOLCHAIN_GCC
#ifdef __arm__
#define TOOLCHAIN_GCC_ARM
#define FILE_HANDLE_NUM     16
#endif
#endif
 ...
 */
#ifndef FILE_HANDLE_NUM
#define FILE_HANDLE_NUM     OPEN_MAX
#endif
static FileHandle *filehandles[FILE_HANDLE_NUM];
...
FileHandle *get_file_handle(int fh) {
    if (fh < 3) return 0;
...
extern "C" void exit(int return_code) {
    ...
    if (return_code) {
        //mbed_die();
        ASSERT(false, "mbed die: %d", return_code);
    }
