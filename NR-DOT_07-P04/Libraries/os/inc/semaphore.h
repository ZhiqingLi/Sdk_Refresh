...
{\
	...
	snprintf((sem).name, sizeof((sem).name), "0x%08X",(unsigned int)&(sem)); \
 ...
 */
extern __asm void __down_failed(void);
extern __asm int  __down_interruptible_failed(void);
extern __asm int  __down_trylock_failed(void);
extern __asm void __up_wakeup(void);

extern __asm void __down_op(void* ptr, void* fail);
extern __asm int __down_op_ret(void* ptr, void* fail, unsigned int timeo);
extern __asm void __up_op(void* ptr, void* wake);
 ...
 */
#define	__OSDOWN_TRYLOCK(sema)	__down_op_ret((void*)sema, (void*)__down_trylock_failed, 0)
#define	__OSDOWN_TIMEOUT(sema, timeo)	__down_op_ret((void*)sema, (void*)__down_interruptible_failed, timeo)
/**
