...
//					用户项目定义
//****************************************************************************************
#define FUNC_ALEXA_WIFI_AUDIO_EN
#define FUNC_MCU_MV_AP8048C_EN 
...
#if 0 //def FUNC_ALEXA_WIFI_AUDIO_EN
...
#else
   #if defined(FUNC_MCU_MV_AP8048C_EN)
   #define WIFI_UART_RX_PORT		BUART_RX_GPIO_B8	// rx port
   #define WIFI_UART_TX_PORT		BUART_TX_GPIO_B9	// tx port
   #else
...
#ifdef FUNC_ALEXA_WIFI_AUDIO_EN
...
#define WIFI_POWER_PORT_BIT				GPIOC13
#else
#define WIFI_POWER_PORT_OUT				GPIO_A_OUT
#define WIFI_POWER_PORT_BIT				GPIOA20
#endif
#endif
...
//	#define POWERON_DEFAULT_VOLUME_EN     //每次开机使用默认音量，不使用记忆音量
	...
	#define SOUND_REMIND_VOL	    32	//设置提示音音量
	#define WIFI_SOUND_REMIND_VOL 32  //WiFi提示音音量
...
//****************************************************************************************
	#define FUNC_LINEIN_EN   					// Linein
	...
	#if defined(FUNC_MCU_MV_AP8048C_EN)
		#define LINEIN_DETECT_PORT_IN		GPIO_C_IN
		#define LINEIN_DETECT_PORT_OE		GPIO_C_OE
		#define LINEIN_DETECT_PORT_IE		GPIO_C_IE
		#define LINEIN_DETECT_PORT_PU		GPIO_C_PU
		#define LINEIN_DETECT_PORT_PD		GPIO_C_PD
		#define LINEIN_DETECT_BIT_MASK		GPIOC12
	#else
	    #define LINEIN_DETECT_PORT_IN		GPIO_C_IN
		#define LINEIN_DETECT_PORT_OE		GPIO_C_OE
		#define LINEIN_DETECT_PORT_IE		GPIO_C_IE
		#define LINEIN_DETECT_PORT_PU		GPIO_C_PU
		#define LINEIN_DETECT_PORT_PD		GPIO_C_PD
		#define LINEIN_DETECT_BIT_MASK		GPIOC1
	#endif
	#endif
...
//                 LINEOUT模式配置 
//****************************************************************************************
	#define FUNC_LINEOUT_EN   					// Linein
	#ifdef FUNC_LINEOUT_EN
	#if defined(FUNC_MCU_MV_AP8048C_EN)
		#define LINEOUT_DETECT_PORT_IN		GPIO_A_IN
		#define LINEOUT_DETECT_PORT_OE		GPIO_A_OE
		#define LINEOUT_DETECT_PORT_IE		GPIO_A_IE
		#define LINEOUT_DETECT_PORT_PU		GPIO_A_PU
		#define LINEOUT_DETECT_PORT_PD		GPIO_A_PD
		#define LINEOUT_DETECT_BIT_MASK		GPIOA10
	#else
	    #define LINEOUT_DETECT_PORT_IN		GPIO_A_IN
		#define LINEOUT_DETECT_PORT_OE		GPIO_A_OE
		#define LINEOUT_DETECT_PORT_IE		GPIO_A_IE
		#define LINEOUT_DETECT_PORT_PU		GPIO_A_PU
		#define LINEOUT_DETECT_PORT_PD		GPIO_A_PD
		#define LINEOUT_DETECT_BIT_MASK		GPIOA12
	#endif
	#endif
...
#define AMP_GPIO_MUTE_EN        //打开该宏，支持GPIO控制功放MUTE
	...
	#define SILENCE_MUTE_DET_CNT      85      //百分比，在200ms内低于检测阀值的百分比达到该值，启动功放MUTE
        ...
        #define AMP_MUTE_PORT_BIT				  GPIOA19
	#else
	    #define AMP_MUTE_PORT_OUT				GPIO_A_OUT
        #define AMP_MUTE_PORT_BIT				  GPIOA23
	#endif
...
//#define FUNC_SLAVE_BLUETOOTH_EN
  ...
  #define SLAVE_BTPOWER_EN
    ...
    #define SLAVE_BTMUTE_PORT_IN		      GPIO_B_INT
...
#if (!defined(WIFI_SELECT_FUART_COM) && !defined(FUNC_MCU_MV_AP8048C_EN))
...
//	  #define FUNC_GPIO_SOFT_PUSH_EN        //软开关用普通GPIO检测，该功能需要用硬开机和普通GPIO配合实现
//	  #define FUNC_GPIO_SLIDE_SWITCH_EN     //硬开关用普通GPIO检测，该功能主要应用在WiFi项目中
//		#define FUNC_GPIO_POWER_ON_EN         //GPIO控制系统上电
		#if  defined(FUNC_GPIO_SOFT_PUSH_EN) || defined(FUNC_GPIO_SLIDE_SWITCH_EN)
		  //#define FUNC_GPIO_POWER_KEY_EN    //GPIO软开关复用功能选择
			#define POWERKEY_DETECT_PORT_PU			GPIO_B_PU
			#define POWERKEY_DETECT_PORT_PD			GPIO_B_PD
			#define POWERKEY_DETECT_PORT_IN			GPIO_B_IN
		  #define POWERKEY_DETECT_PORT_IE			GPIO_B_IE
			#define POWERKEY_DETECT_PORT_OE			GPIO_B_OE
			#define POWERKEY_DETECT_PORT_DS			GPIO_B_DS
			#define POWERKEY_DETECT_BIT				  GPIOB2
		#endif
