...
{
#ifdef FUNC_WIFI_EN
    {MODULE_ID_WIFI,           MSG_NONE,               MSG_NONE,               NULL},
#endif
  ...
  {MODULE_ID_SLAVE_BLUETOOTH,           MSG_NONE,               MSG_NONE,               NULL},
#endif
	...
	{MODULE_ID_PLAYER_WIFI_USB,		MSG_NONE,			MSG_NONE,		IsWiFiUSBLink},
#endif

#ifdef FUNC_WIFI_PLAY_CARD_EN
	{MODULE_ID_PLAYER_WIFI_SD, 		MSG_NONE,			MSG_NONE,		IsWiFiCardLink},
#endif
};
