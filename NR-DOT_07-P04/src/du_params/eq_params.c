...
//EQ style: DOT
static const EqFilterParams _EqStyle10[2] = 
{
	{ 0x0004, 0x0190, 0x0400, 0x03e3 }, // Parameters for filter 0
	{ 0x0003, 0x4650, 0x02cd, 0x0400 }, // Parameters for filter 4
};
