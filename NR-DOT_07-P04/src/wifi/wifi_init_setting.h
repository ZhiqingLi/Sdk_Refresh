...
#include "app_config.h"
	...
	//#define FUNC_BAIDU_SCTEL_PRJECT_EN
	//#define FUNC_BAIDU_HNTEL_PRJECT_EN
	#define FUNC_BAIDU_KNOWBEST_PRJECT_EN
#endif
//****************************************************************************************
//					WiFi产品的相关定制参数设置
//****************************************************************************************
	...
	#define MCU_CAP_PRJ_PROJECT_NAME	"L2"
	#define MCU_SSID_NAME	"JS_DOT"
#elif defined(FUNC_BAIDU_HNTEL_PRJECT_EN)
	//**MCU+CAP+PRJproject_name&:项目名称定义
	#define MCU_CAP_PRJ_PROJECT_NAME	"L3"
	#define MCU_SSID_NAME	"JS_DOT"
#elif defined(FUNC_BAIDU_KNOWBEST_PRJECT_EN)
	//**MCU+CAP+PRJproject_name&:项目名称定义
	#define MCU_CAP_PRJ_PROJECT_NAME	"KnowBest_D1"
...
#define MCU_PTV_NUM		002		//nnn为0~999的数字，表示使用的MCU 协议的版本号，默认000；此项设定和capacity 的位定义有依赖关系?
	...
	#define MCU_ALI_PID_PRODUCTID	"NARUI_ENTERTAINMENT_ATALK_NR_DOT"	//如果这是一个阿里小智的项目，请回复此项，productid来自阿里提供的prodconf.json文件里面model字段，例如：EDIFIER_ENTERTAINMENT_ATALK_MA1
