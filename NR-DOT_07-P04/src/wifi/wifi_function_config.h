...
//	以下宏定义可以根据功能需要开关
//************************************************
#define FUNC_POWERON_USE_DEFAULT_VOLME				//打开此宏定义，开机音量不记忆，使用默认音量
...
//#define FUNC_WIFI_DUMI_PROJECT_EN	 				//打开此宏定义，支持百度度秘项目特殊功能
...
//#define FUNC_MCU_SET_WIFI_PASS_WORD_EN 			//打开此宏定义，支持MCU设置WIFI密码
#endif
#endif
