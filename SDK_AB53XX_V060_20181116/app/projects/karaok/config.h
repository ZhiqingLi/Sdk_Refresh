 ...
 * Module    : 系统功能选择配置
 *****************************************************************************/
#define BUCK_MODE_EN                    0                       //是否BUCK MODE
...
#define FLASH_SIZE                      FSIZE_512K              //LQFP48芯片内置1MB，其它封装芯片内置512KB(实际导出prd文件要小于496K)
...
#define KARAOK_REC_EN                   1   //是否打开KARAOK录音功能，需同步打开KARAOK功能
...
#define REC_STOP_MUTE_1S                1   //录音停止时, MUTE 1S功放. //提醒客户录音结束.
#define REC_TYPE_SEL                    REC_MP3

/*****************************************************************************
 * Module    : K歌功能配置
 *****************************************************************************/
#define SYS_KARAOK_EN                   1   //是否打开K歌功能
...
#define USER_KEY_KNOB_LEVEL             12          //旋钮级数
