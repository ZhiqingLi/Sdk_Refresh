...
#define WIFI_MIC_PORT_BIT				GPIOB7
#endif
...
#define FUNC_SLAVE_BLUETOOTH_EN
  ...
  #define SLAVE_BTPOWER_EN
    ...
    #define SLAVE_BTPOWER_PORT_BIT				  GPIOB31
    ...
    #define SLAVE_BTPLAY_PORT_BIT				  GPIOB27
    ...
    #define SLAVE_BTPREV_PORT_BIT				  GPIOB28
    ...
    #define SLAVE_BTDETE_PORT_BIT				  GPIOB30
    ...
    #define SLAVE_BTMUTE_PORT_BIT				  GPIOB26
...
//	#define USE_POWERKEY_SLIDE_SWITCH     //for slide switch case ONLY
  ...
  #define POWERON_DETECT_VOLTAGE        //开机检测电池电压，低于关机电压则直接进入关机流程
	...
	#define	OPTION_CHARGER_DETECT		      //打开该宏定义，支持GPIO检测充电设备插入功能
			...
			#define CHARGE_DETECT_BIT				  GPIOB2
	#endif
...
//GPIO按键定义
	#define FUNC_GPIO_KEY_EN   							//IIC 从机按键
	  #ifdef FUNC_GPIO_KEY_EN
		  #define GPIO_KEY_PORT_OUT			GPIO_C_OUT		
		  #define GPIO_KEY_PORT_BIT		  GPIOC2		 	
		#endif
...
//蓝灯	
 ...
 #define  LED_WHITE_MODE_ON()      do{\
							                     PwmConfig(LED_RED_PWM_PORT_MASK, 1200, 1200);\
							                     PwmEnableChannel(LED_RED_PWM_PORT_MASK, PWM_IO_SEL1, PWM_MODE_OUT);\
							                     PwmConfig(LED_GREEN_PWM_PORT_MASK, 1200, 900);\
							                     PwmEnableChannel(LED_GREEN_PWM_PORT_MASK, PWM_IO_SEL1, PWM_MODE_OUT);\
							                     PwmConfig(LED_BLUE_PWM_PORT_MASK, 1200, 900);\
							                     PwmEnableChannel(LED_BLUE_PWM_PORT_MASK, PWM_IO_SEL1, PWM_MODE_OUT);\
									                 }while(0)
