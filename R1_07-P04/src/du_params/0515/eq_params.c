...
static const EqFilterParams _EqStyle10[9] = 
{
	...
	{ 0x0000, 0x00b4, 0x0400, 0x0384 }, // Parameters for filter 2
	{ 0x0000, 0x0190, 0x0733, 0x04c1 }, // Parameters for filter 3
	{ 0x0000, 0x0708, 0x059a, 0x03ab }, // Parameters for filter 4
	{ 0x0000, 0x0bb8, 0x0800, 0x049e }, // Parameters for filter 5
	{ 0x0000, 0x0fa0, 0x0666, 0x040f }, // Parameters for filter 6
	{ 0x0000, 0x1450, 0x0600, 0x0391 }, // Parameters for filter 7
	{ 0x0000, 0x1f40, 0x099a, 0x045c }, // Parameters for filter 8
	{ 0x0000, 0x34bc, 0x0600, 0x042d }, // Parameters for filter 9
};
