...
void GpioRedWhiteLedControl(void)
{
	static bool IsLedStatus = 0;
	
	IsLedStatus = !IsLedStatus;
	if(IsLedStatus){
		GpioClrRegOneBit(GPIO_B_PU, GPIOB20);
	  GpioClrRegOneBit(GPIO_B_PD, GPIOB20);
	  GpioClrRegOneBit(GPIO_B_IE, GPIOB20);
	  GpioSetRegOneBit(GPIO_B_OE, GPIOB20);
	  GpioSetRegOneBit(GPIO_B_OUT, GPIOB20);
	  ...
	  GpioSetRegOneBit(GPIO_B_OUT, GPIOB22);
		
		GpioClrRegOneBit(GPIO_B_PU, GPIOB21);
	  GpioClrRegOneBit(GPIO_B_PD, GPIOB21);
	  GpioClrRegOneBit(GPIO_B_IE, GPIOB21);
	  GpioSetRegOneBit(GPIO_B_OE, GPIOB21);
	  GpioClrRegOneBit(GPIO_B_OUT, GPIOB21);
		
		GpioClrRegOneBit(GPIO_B_PU, GPIOB23);
	  GpioClrRegOneBit(GPIO_B_PD, GPIOB23);
	  GpioClrRegOneBit(GPIO_B_IE, GPIOB23);
	  GpioSetRegOneBit(GPIO_B_OE, GPIOB23);
	  GpioClrRegOneBit(GPIO_B_OUT, GPIOB23);
	}
	else{
		GpioClrRegOneBit(GPIO_B_PU, GPIOB20);
	  GpioClrRegOneBit(GPIO_B_PD, GPIOB20);
	  GpioClrRegOneBit(GPIO_B_IE, GPIOB20);
	  GpioSetRegOneBit(GPIO_B_OE, GPIOB20);
	  GpioClrRegOneBit(GPIO_B_OUT, GPIOB20);
		
		GpioClrRegOneBit(GPIO_B_PU, GPIOB22);
	  GpioClrRegOneBit(GPIO_B_PD, GPIOB22);
	  GpioClrRegOneBit(GPIO_B_IE, GPIOB22);
	  GpioSetRegOneBit(GPIO_B_OE, GPIOB22);
	  GpioClrRegOneBit(GPIO_B_OUT, GPIOB22);
		
		GpioClrRegOneBit(GPIO_B_PU, GPIOB21);
	  GpioClrRegOneBit(GPIO_B_PD, GPIOB21);
	  GpioClrRegOneBit(GPIO_B_IE, GPIOB21);
	  GpioSetRegOneBit(GPIO_B_OE, GPIOB21);
	  GpioSetRegOneBit(GPIO_B_OUT, GPIOB21);
		
		GpioClrRegOneBit(GPIO_B_PU, GPIOB23);
	  GpioClrRegOneBit(GPIO_B_PD, GPIOB23);
	  GpioClrRegOneBit(GPIO_B_IE, GPIOB23);
	  GpioSetRegOneBit(GPIO_B_OE, GPIOB23);
	  GpioSetRegOneBit(GPIO_B_OUT, GPIOB23);
	}
}
#endif
