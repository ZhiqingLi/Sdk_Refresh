...
{
	{ 0x0004, 0x0023, 0x031f, 0x0380 }, // Parameters for filter 0
	{ 0x0000, 0x004b, 0x0271, 0x0464 }, // Parameters for filter 1
	{ 0x0000, 0x05dc, 0x0733, 0x0456 }, // Parameters for filter 2
	{ 0x0000, 0x158b, 0x0600, 0x0443 }, // Parameters for filter 3
	{ 0x0002, 0x3cc7, 0x03ec, 0x045c }, // Parameters for filter 4
};
