...
{		
	...
	{			
		...
		case MSG_STOP:
#if defined(BT_REDIAL_CALL_IPONE)
			{
...
#elif defined(TEST_CLEAR_BT_PAIRED_INFO)
			{
...
bool PlayerControl(void)
{
	...
	//解决蓝牙播放自动切换模式播放状态不同步的问题。
#ifdef FUNC_BT_EN
	{
		extern bool a2dp_player_switch_bluetooth;
		if(a2dp_player_switch_bluetooth)
		{
			SetPlayState(PLAYER_STATE_PLAYING);
			a2dp_player_switch_bluetooth = FALSE;
		}
	}
#endif
