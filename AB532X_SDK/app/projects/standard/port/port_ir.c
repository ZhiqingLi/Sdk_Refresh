...
{
// 	   0              1 		     2	            3             4               5             6                 7
/*0*/  NO_KEY,        NO_KEY,        NO_KEY,        NO_KEY,       NO_KEY,         NO_KEY,       NO_KEY,           KEY_VOL_DOWN,
       KEY_NUM_4,     KEY_EQ,        NO_KEY,	    NO_KEY,		  KEY_NUM_1,      KEY_REPEAT,	NO_KEY,			  NO_KEY,
/*1*/  NO_KEY,        NO_KEY,        NO_KEY,        NO_KEY,       NO_KEY,         KEY_VOL_UP,   KEY_NUM_0,	      NO_KEY,
       KEY_NUM_2,     NO_KEY,        NO_KEY,        NO_KEY,	      KEY_NUM_5,      NO_KEY,	    NO_KEY,			  NO_KEY,
...
/*3*/  NO_KEY,        NO_KEY,        NO_KEY,        NO_KEY,       NO_KEY,         NO_KEY,	    NO_KEY,			  NO_KEY,
       NO_KEY,		  NO_KEY,		 NO_KEY,	    NO_KEY,		  NO_KEY,		  NO_KEY,	    NO_KEY,			  NO_KEY,
/*4*/  KEY_NEXT,      NO_KEY,        KEY_NUM_7,     KEY_PLAY,     KEY_PREV,       KEY_IR_POWER, KEY_MODE,         KEY_MUTE,
